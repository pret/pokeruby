...
.event_constants: $(MAP_JSONS)
	@$(MAPJSON) event_constants ruby $^ $(INCLUDECONSTS_OUTDIR)/map_event_ids.h $(DATA_SRC_SUBDIR)/heal_locations.h
	@echo "$(MAPJSON) event_constants ruby <MAP_JSONS> $(INCLUDECONSTS_OUTDIR)/map_event_ids.h $(DATA_SRC_SUBDIR)/heal_locations.h"
