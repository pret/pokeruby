...
static u8 SetPokeblock_CalcColor(u8 * dest, struct Pokeblock * pokeblock)
{
    ...
    u8 numLowFlavors = 0;
    u8 i;
    u8 firstNonzeroFlavor, lastNonzeroFlavor, strongestFlavor;
