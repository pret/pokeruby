...
u8 *de_sub_8040FE0(u8 arg0) {
    if (arg0) {
        arg0++;

    }

    arg0 = TRAINER_CLASS_LEADER_F;
    return gTrainerClassNames[arg0];
}

u8 *de_sub_8040FF4(u8 arg0) {
    if (arg0) {
        arg0++;

    }

    arg0 = TRAINER_CLASS_BIRD_KEEPER;
    return gTrainerClassNames[arg0];
}

u8 *de_sub_804100C(u8 arg0) {
    if (arg0) {
        arg0++;
    }

    arg0 = TRAINER_CLASS_ELITE_FOUR_F;
    return gTrainerClassNames[arg0];
}
...
u8 *de_sub_8041024(s32 arg0, u32 arg1) {
    ...
    switch (arg0) {
        case 0x400:
            ...
            local1 = gSecretBaseRecord.gender;
            if (nameIndex == TRAINER_CLASS_LEADER_F) {
                return de_sub_8040FE0(local1);
            }
            break;

        case 0x100:
            local1 = de_sub_81364AC();
            nameIndex = get_trainer_class_name_index();
            if (local1 == TRAINER_CLASS_SCHOOL_KID_F) {
                return de_sub_8040FE0(TRUE);
            }
            if (local1 == TRAINER_CLASS_MAY_1 || local1 == TRAINER_CLASS_MAY_2 || local1 == TRAINER_CLASS_MAY_3) {
                return de_sub_8040FF4(TRUE);
            }

            return gTrainerClassNames[nameIndex];

        case 0x800:
            local1 = de_sub_81364F8();
        ...
        default: {
            ...
            nameIndex = trainer->trainerClass;
            local2 = sub_803FC58(arg1);

            if (nameIndex == TRAINER_CLASS_LEADER_F || (nameIndex == TRAINER_CLASS_BIRD_KEEPER && local2 == 1)) {
                return de_sub_8040FF4(TRUE);
            }

            if (nameIndex == TRAINER_CLASS_ELITE_FOUR_F) {
                if (gTrainers[arg1].doubleBattle == TRUE) {
                    return de_sub_804100C(TRUE);
                } else {
                    return de_sub_804100C(FALSE);
                }
            }
        }
    }
