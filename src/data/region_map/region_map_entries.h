...
const u8 sMapName_LittlerootTown[] = _("LITTLEROOT{NAME_END} TOWN");
const u8 sMapName_OldaleTown[] = _("OLDALE{NAME_END} TOWN");
const u8 sMapName_DewfordTown[] = _("DEWFORD{NAME_END} TOWN");
const u8 sMapName_LavaridgeTown[] = _("LAVARIDGE{NAME_END} TOWN");
const u8 sMapName_FallarborTown[] = _("FALLARBOR{NAME_END} TOWN");
const u8 sMapName_VerdanturfTown[] = _("VERDANTURF{NAME_END} TOWN");
const u8 sMapName_PacifidlogTown[] = _("PACIFIDLOG{NAME_END} TOWN");
const u8 sMapName_PetalburgCity[] = _("PETALBURG{NAME_END} CITY");
const u8 sMapName_SlateportCity[] = _("SLATEPORT{NAME_END} CITY");
const u8 sMapName_MauvilleCity[] = _("MAUVILLE{NAME_END} CITY");
const u8 sMapName_RustboroCity[] = _("RUSTBORO{NAME_END} CITY");
const u8 sMapName_FortreeCity[] = _("FORTREE{NAME_END} CITY");
const u8 sMapName_LilycoveCity[] = _("LILYCOVE{NAME_END} CITY");
const u8 sMapName_MossdeepCity[] = _("MOSSDEEP{NAME_END} CITY");
const u8 sMapName_SootopolisCity[] = _("SOOTOPOLIS{NAME_END} CITY");
const u8 sMapName_EverGrandeCity[] = _("EVER GRANDE{NAME_END} CITY");
...
const u8 sMapName_Underwater[] = _("UNDERWATER");
const u8 sMapName_GraniteCave[] = _("GRANITE CAVE");
const u8 sMapName_MtChimney[] = _("MT. CHIMNEY");
const u8 sMapName_SafariZone[] = _("SAFARI ZONE");
const u8 sMapName_BattleTower[] = _("BATTLE TOWER");
const u8 sMapName_PetalburgWoods[] = _("PETALBURG WOODS");
const u8 sMapName_RusturfTunnel[] = _("RUSTURF TUNNEL");
const u8 sMapName_AbandonedShip[] = _("ABANDONED SHIP");
const u8 sMapName_NewMauville[] = _("NEW MAUVILLE");
const u8 sMapName_MeteorFalls[] = _("METEOR FALLS");
const u8 sMapName_MtPyre[] = _("MT. PYRE");
const u8 sMapName_EvilTeamHideout[] = _("{EVIL_TEAM} HIDEOUT");
const u8 sMapName_ShoalCave[] = _("SHOAL CAVE");
const u8 sMapName_SeafloorCavern[] = _("SEAFLOOR CAVERN");
const u8 sMapName_VictoryRoad[] = _("VICTORY ROAD");
const u8 sMapName_MirageIsland[] = _("MIRAGE ISLAND");
const u8 sMapName_CaveOfOrigin[] = _("CAVE OF ORIGIN");
const u8 sMapName_SouthernIsland[] = _("SOUTHERN ISLAND");
const u8 sMapName_FieryPath[] = _("FIERY PATH");
const u8 sMapName_JaggedPass[] = _("JAGGED PASS");
const u8 sMapName_SealedChamber[] = _("SEALED CHAMBER");
const u8 sMapName_ScorchedSlab[] = _("SCORCHED SLAB");
const u8 sMapName_IslandCave[] = _("ISLAND CAVE");
const u8 sMapName_DesertRuins[] = _("DESERT RUINS");
const u8 sMapName_AncientTomb[] = _("ANCIENT TOMB");
const u8 sMapName_InsideOfTruck[] = _("INSIDE OF TRUCK");
const u8 sMapName_SkyPillar[] = _("SKY PILLAR");
const u8 sMapName_SecretBase[] = _("SECRET BASE");
