...
sub_8104CAC: @ 8104CAC
	...
	lsrs r5, r0, 24
	bl sub_8104DA4
	ldr r0, _08104D38 @ =0x02000000
	adds r0, 0x3D
	ldrb r1, [r0]
	lsls r0, r1, 2
	adds r0, r1
	lsls r0, 3
	ldr r1, _08104D3C @ =gTasks
	adds r6, r0, r1
	strh r5, [r6, 0xA]
	movs r4, 0
	ldr r3, _08104D40 @ =gUnknown_083ED048
	lsls r2, r5, 2
	adds r0, r2, r3
	ldr r0, [r0]
	ldrb r0, [r0]
...
_08104D30:
	...
	bx r0
	.align 2, 0
_08104D38: .4byte 0x02000000
_08104D3C: .4byte gTasks
_08104D40: .4byte gUnknown_083ED048
_08104D44: .4byte gSprites
