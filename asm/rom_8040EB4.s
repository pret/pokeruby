...
_08046DA0: .4byte gMPlay_BkgndMusic
_08046DA4:
	ldr r0, _08046DC8
	ldr r1, _08046DCC
	movs r2, 0x80
...
_08046DC4:
	...
	b _08046DF6
	.align 2, 0
_08046DC8: .4byte gMPlay_BkgndMusic
...
sub_804E290: @ 804E290
	...
	bx r0
	.align 2, 0
_0804E2B0: .4byte gMPlay_SoundEffect2
...
_08050030: .4byte gMPlay_BkgndMusic
_08050034:
	ldr r0, _08050098
	movs r1, 0x80
	lsls r1, 1
...
_08050088:
	...
	bx r0
	.align 2, 0
_08050098: .4byte gMPlay_BkgndMusic
...
_080509B4:
	...
	b _080509E4
	.align 2, 0
_080509C8: .4byte gMPlay_BkgndMusic
_080509CC:
	ldr r0, _080509F0
	ldr r0, [r0]
	movs r1, 0xA4
...
_08050A40:
	...
	b _08050CB6
	.align 2, 0
_08050A48: .4byte gMPlay_SoundEffect2
_08050A4C:
	bl GetMultiplayerId
	lsls r0, 24
	cmp r0, 0
