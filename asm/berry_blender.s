...
sub_804E9F8: @ 804E9F8
	...
	push {r7}
	sub sp, 0x4
	ldr r1, _0804EA18 @ =sBerryBlenderData
	ldr r0, [r1]
	ldrb r0, [r0]
	mov r8, r1
	cmp r0, 0x66
...
_0804EA0E:
	...
	mov pc, r0
	.align 2, 0
_0804EA18: .4byte sBerryBlenderData
...
_0804EBBC:
	...
	bl ResetTasks
	ldr r0, _0804EC60 @ =VBlankCB0_BerryBlender
	...
	adds r0, r2, 0
	strh r0, [r1]
	ldr r3, _0804EC70 @ =sBerryBlenderData
	ldr r1, [r3]
	ldrb r0, [r1]
	adds r0, 0x1
	movs r2, 0
...
_0804EC74:
	...
	b _0804F0CE
_0804EC80:
	ldr r0, _0804EC90 @ =sBerryBlenderData
	ldr r1, [r0]
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
	...
	b _0804F0CE
	.align 2, 0
_0804EC90: .4byte sBerryBlenderData
_0804EC94:
	movs r5, 0
	ldr r4, _0804ECD8 @ =sBlenderSyncArrowsPos
	ldr r6, _0804ECDC @ =sBerryBlenderData
_0804EC9A:
	ldrb r1, [r4]
	ldrb r2, [r4, 0x1]
	ldr r0, _0804ECE0 @ =sBlenderSyncArrow_SpriteTemplate
	movs r3, 0x1
	bl CreateSprite
	ldr r1, [r6]
	adds r1, 0x60
	...
	b _0804F0AA
	.align 2, 0
_0804ECD8: .4byte sBlenderSyncArrowsPos
_0804ECDC: .4byte sBerryBlenderData
_0804ECE0: .4byte sBlenderSyncArrow_SpriteTemplate
...
_0804ED14:
	...
	movs r2, 0xE
	bl MenuPrint
	ldr r2, _0804ED44 @ =sBerryBlenderData
	ldr r1, [r2]
	movs r3, 0
	movs r0, 0x8
	strb r0, [r1]
...
_0804ED44: .4byte sBerryBlenderData
_0804ED48:
	mov r2, r8
	ldr r1, [r2]
	ldrb r0, [r1]
...
_0804EE46:
	bl GetLinkPlayerCount
	ldr r2, _0804EE98 @ =sBerryBlenderData
	ldr r1, [r2]
	adds r1, 0x88
	strb r0, [r1]
	movs r5, 0
...
_0804EE6C:
	...
	ble _0804EE6C
_0804EE7A:
	ldr r3, _0804EE98 @ =sBerryBlenderData
	ldr r1, [r3]
	movs r4, 0x98
	lsls r4, 1
	adds r2, r1, r4
	...
	b _0804F0AE
	.align 2, 0
_0804EE98: .4byte sBerryBlenderData
...
_0804EF16:
	...
	b _0804F0CE
_0804EF22:
	ldr r2, _0804EF30 @ =sBerryBlenderData
	ldr r1, [r2]
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
	...
	b _0804EFBC
	.align 2, 0
_0804EF30: .4byte sBerryBlenderData
_0804EF34:
	movs r2, 0x80
	lsls r2, 19
	ldrh r0, [r2]
...
_0804EFD8:
	...
	cmp r0, 0
	beq _0804EFF6
	ldr r0, _0804F008 @ =sBerryBlenderData
	ldr r1, [r0]
	movs r3, 0x98
	lsls r3, 1
	adds r2, r1, r3
...
_0804EFF6:
	...
	b _0804F0CE
	.align 2, 0
_0804F008: .4byte sBerryBlenderData
_0804F00C:
...
_0804F0A0:
	...
	beq _0804F0CE
_0804F0AA:
	ldr r0, _0804F0B8 @ =sBerryBlenderData
_0804F0AC:
	ldr r1, [r0]
_0804F0AE:
	ldrb r0, [r1]
	...
	b _0804F0CE
	.align 2, 0
_0804F0B8: .4byte sBerryBlenderData
_0804F0BC:
...
sub_804F0F4: @ 804F0F4
	...
	bl FreeAllSpritePalettes
	bl ResetTasks
	ldr r0, _0804F158 @ =VBlankCB0_BerryBlender
	bl SetVBlankCallback
	...
	adds r0, r2, 0
	strh r0, [r1]
	ldr r0, _0804F168 @ =sBerryBlenderData
	ldr r2, [r0]
	adds r0, r2, 0
	adds r0, 0x4E
	movs r1, 0
...
task_tutorial_oak_boy_girl: @ 804F16C
	...
	adds r2, r0, 0
	adds r2, 0x18
	ldr r0, _0804F1A8 @ =sBerryBlenderData
	ldr r0, [r0]
	lsrs r1, 23
	adds r0, 0xA2
	adds r0, r1
	...
	b _0804F1B6
	.align 2, 0
_0804F1A8: .4byte sBerryBlenderData
...
sub_804F238: @ 804F238
	push {r4-r7,lr}
	movs r4, 0
	ldr r7, _0804F2A0 @ =sBerryBlenderData
	movs r6, 0xFF
...
_0804F28E:
	...
	bx r0
	.align 2, 0
_0804F2A0: .4byte sBerryBlenderData
...
BuyMenuDrawFieldObjects: @ 804F2A8
	...
	push {r7}
	movs r6, 0
	ldr r7, _0804F360 @ =sBerryBlenderData
...
_0804F34A:
	...
	bx r0
	.align 2, 0
_0804F360: .4byte sBerryBlenderData
...
sub_804F378: @ 804F378
	...
	push {r7}
	sub sp, 0x4
	ldr r1, _0804F398 @ =sBerryBlenderData
	ldr r0, [r1]
	ldrb r0, [r0]
	mov r8, r1
	cmp r0, 0x15
...
_0804F38E:
	...
	mov pc, r0
	.align 2, 0
_0804F398: .4byte sBerryBlenderData
...
_0804F3F8:
	...
	movs r0, 0
	bl sub_80516C4
	ldr r5, _0804F470 @ =sBerryBlenderData
	ldr r0, [r5]
	movs r6, 0xBE
	lsls r6, 1
	adds r0, r6
...
_0804F470: .4byte sBerryBlenderData
_0804F474:
	bl sub_804E2EC
	lsls r0, 24
	cmp r0, 0
	...
	b _0804F7E6
_0804F480:
	ldr r0, _0804F490 @ =sBerryBlenderData
	ldr r1, [r0]
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
	...
	b _0804F7E6
	.align 2, 0
_0804F490: .4byte sBerryBlenderData
_0804F494:
	movs r4, 0
	ldr r5, _0804F4DC @ =sBlenderSyncArrowsPos
	ldr r6, _0804F4E0 @ =sBerryBlenderData
_0804F49A:
	ldrb r1, [r5]
	ldrb r2, [r5, 0x1]
	ldr r0, _0804F4E4 @ =sBlenderSyncArrow_SpriteTemplate
	movs r3, 0x1
	bl CreateSprite
	ldr r1, [r6]
	adds r1, 0x60
	...
	cmp r4, 0x3
	ble _0804F49A
	ldr r0, _0804F4E0 @ =sBerryBlenderData
	ldr r1, [r0]
	b _0804F74C
	.align 2, 0
_0804F4DC: .4byte sBlenderSyncArrowsPos
_0804F4E0: .4byte sBerryBlenderData
_0804F4E4: .4byte sBlenderSyncArrow_SpriteTemplate
...
_0804F4EC:
	...
	movs r3, 0
	bl BeginNormalPaletteFade
	ldr r2, _0804F514 @ =sBerryBlenderData
	ldr r1, [r2]
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
	...
	b _0804F7E6
	.align 2, 0
_0804F514: .4byte sBerryBlenderData
_0804F518:
	mov r2, r8
	ldr r1, [r2]
	movs r3, 0x98
...
_0804F578:
	...
	ldr r0, _0804F5C4 @ =sBerryBlenderData
	ldr r3, [r0]
	adds r0, r3, 0
	adds r0, 0x88
	ldrb r0, [r0]
...
_0804F594:
	...
	ble _0804F594
_0804F5A2:
	ldr r3, _0804F5C4 @ =sBerryBlenderData
	ldr r1, [r3]
	movs r5, 0x98
	lsls r5, 1
	adds r2, r1, r5
...
_0804F5C4: .4byte sBerryBlenderData
_0804F5C8:
	mov r1, r8
	ldr r3, [r1]
	movs r2, 0x98
...
_0804F6F8:
	...
	cmp r0, 0
	beq _0804F70C
	ldr r0, _0804F71C @ =sBerryBlenderData
	ldr r1, [r0]
	ldrb r0, [r1]
	adds r0, 0x1
	strb r0, [r1]
...
_0804F710:
	...
	b _0804F7E6
	.align 2, 0
_0804F71C: .4byte sBerryBlenderData
_0804F720:
	...
	movs r3, 0x3
	bl CreateSprite
	ldr r0, _0804F738 @ =sBerryBlenderData
	ldr r1, [r0]
	b _0804F74C
	.align 2, 0
_0804F734: .4byte gSpriteTemplate_8216548
_0804F738: .4byte sBerryBlenderData
_0804F73C:
	mov r5, r8
	ldr r1, [r5]
	b _0804F74C
...
_0804F754:
	bl sub_804F81C
	ldr r3, _0804F804 @ =sBerryBlenderData
	ldr r4, [r3]
	adds r5, r4, 0
	adds r5, 0x56
	movs r2, 0
...
_0804F792:
	...
	lsrs r1, r5, 24
	bl CreateTask
	ldr r1, _0804F804 @ =sBerryBlenderData
	ldr r1, [r1]
	movs r2, 0xA4
	lsls r2, 1
	adds r1, r2
...
_0804F7E6:
	...
	bx r0
	.align 2, 0
_0804F804: .4byte sBerryBlenderData
...
sub_804F8C8: @ 804F8C8
	...
	lsls r0, 24
	lsrs r5, r0, 24
	ldr r4, _0804F934 @ =sBerryBlenderData
	ldr r0, [r4]
	adds r0, 0x54
	ldrh r0, [r0]
	movs r1, 0x1
...
_0804F8FC:
	...
	b _0804F954
	.align 2, 0
_0804F934: .4byte sBerryBlenderData
...
sub_804F9F4: @ 804F9F4
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r6, _0804FA78 @ =sBerryBlenderData
	ldr r3, [r6]
	adds r0, r3, 0
	adds r0, 0x54
	ldrh r0, [r0]
	...
	b _0804FAD4
	.align 2, 0
_0804FA78: .4byte sBerryBlenderData
...
sub_804FB1C: @ 804FB1C
	...
	lsls r0, 24
	lsrs r4, r0, 24
	ldr r5, _0804FB9C @ =sBerryBlenderData
	ldr r3, [r5]
	adds r0, r3, 0
	adds r0, 0x54
	ldrh r0, [r0]
	...
	b _0804FC02
	.align 2, 0
_0804FB9C: .4byte sBerryBlenderData
