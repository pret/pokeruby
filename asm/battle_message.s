...
_08120E10:
	mov r0, r10
	bl sub_8121D1C
	ldr r0, _08120E3C @ =gSelectedOrderFromParty
	ldr r2, [r0]
	ldrh r1, [r2]
	movs r0, 0xB1
	lsls r0, 1
	...
	b _08120E60
	.align 2, 0
_08120E3C: .4byte gSelectedOrderFromParty
...
_08121264:
	ldr r4, _081212A8 @ =gPlayerMonIndex
	ldrb r0, [r4]
	bl battle_side_get_owner
	lsls r0, 24
	cmp r0, 0
	...
	b _081212BE
	.align 2, 0
_081212A8: .4byte gPlayerMonIndex
...
_081212E8:
	ldr r4, _08121314 @ =gPlayerMonIndex
	ldrb r0, [r4]
	bl battle_side_get_owner
	lsls r0, 24
	cmp r0, 0
	...
	b _08121872
	.align 2, 0
_08121314: .4byte gPlayerMonIndex
...
_08121354:
	ldr r4, _08121388 @ =gPlayerMonIndex
	ldrb r0, [r4]
	bl battle_side_get_owner
	lsls r0, 24
	cmp r0, 0
	...
	b _0812139E
	.align 2, 0
_08121388: .4byte gPlayerMonIndex
...
_081213B8:
	ldr r4, _081213EC @ =gEnemyMonIndex
	ldrb r0, [r4]
	bl battle_side_get_owner
	lsls r0, 24
	cmp r0, 0
	...
	b _08121402
	.align 2, 0
_081213EC: .4byte gEnemyMonIndex
...
_08121550:
	ldr r0, _08121568 @ =gSelectedOrderFromParty
	ldr r2, [r0]
	ldrh r1, [r2]
	movs r0, 0xB1
	lsls r0, 1
	...
	b _0812158C
	.align 2, 0
_08121568: .4byte gSelectedOrderFromParty
...
_08121574:
	...
	b _081215AA
_08121578:
	ldr r0, _08121598 @ =gSelectedOrderFromParty
	ldr r2, [r0]
	ldrh r1, [r2, 0x2]
	movs r0, 0xB1
	lsls r0, 1
...
_0812158C:
	...
	b _0812191E
	.align 2, 0
_08121598: .4byte gSelectedOrderFromParty
...
_0812164C:
	...
	ldr r0, _08121658 @ =gPlayerMonIndex
	b _08121688
	.align 2, 0
_08121654: .4byte gUnknown_0203926C
_08121658: .4byte gPlayerMonIndex
_0812165C:
	ldr r1, _08121664 @ =gUnknown_0203926C
	ldr r0, _08121668 @ =gEnemyMonIndex
	b _08121688
	.align 2, 0
_08121664: .4byte gUnknown_0203926C
_08121668: .4byte gEnemyMonIndex
_0812166C:
...
_081218B4:
	ldr r0, _081218B8 @ =gPlayerMonIndex
	b _081218BE
	.align 2, 0
_081218B8: .4byte gPlayerMonIndex
_081218BC:
	ldr r0, _081218D0 @ =gEnemyMonIndex
_081218BE:
	ldrb r0, [r0]
	bl battle_side_get_owner
	lsls r0, 24
	...
	b _0812191E
	.align 2, 0
_081218D0: .4byte gEnemyMonIndex
_081218D4: .4byte gUnknown_084007A7
_081218D8: .4byte gUnknown_084007AC
_081218DC:
	ldr r0, _081218E0 @ =gPlayerMonIndex
	b _081218E6
	.align 2, 0
_081218E0: .4byte gPlayerMonIndex
_081218E4:
	ldr r0, _081218F8 @ =gEnemyMonIndex
_081218E6:
	ldrb r0, [r0]
	bl battle_side_get_owner
	lsls r0, 24
	...
	b _0812191E
	.align 2, 0
_081218F8: .4byte gEnemyMonIndex
_081218FC: .4byte gUnknown_0840079C
_08121900: .4byte gUnknown_084007A1
_08121904:
	ldr r0, _08121908 @ =gPlayerMonIndex
	b _0812190E
	.align 2, 0
_08121908: .4byte gPlayerMonIndex
_0812190C:
	ldr r0, _08121960 @ =gEnemyMonIndex
_0812190E:
	ldrb r0, [r0]
	bl battle_side_get_owner
	lsls r0, 24
...
_08121940:
	...
	b _08121978
	.align 2, 0
_08121960: .4byte gEnemyMonIndex
