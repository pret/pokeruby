...
LilycoveCity_Harbor_EventScript_1598BA:: @ 81598BA
	...
	loadptr 0, LilycoveCity_Harbor_Text_18B306
	callstd 4
	release
	end

LilycoveCity_Harbor_EventScript_1598CD:: @ 81598CD
	loadptr 0, LilycoveCity_Harbor_Text_18B36F
	callstd 4
...
LilycoveCity_Harbor_EventScript_159929:: @ 8159929
	loadptr 0, LilycoveCity_Harbor_Text_18B3A9
	callstd 4
	release
	end

LilycoveCity_Harbor_EventScript_159933:: @ 8159933
	loadptr 0, LilycoveCity_Harbor_Text_18B47D
	callstd 5
	compare RESULT, 0
...
LilycoveCity_Harbor_EventScript_15995B:: @ 815995B
	loadptr 0, LilycoveCity_Harbor_Text_18B499
	callstd 5
	compare RESULT, 0
	jumpeq LilycoveCity_Harbor_EventScript_15997E
	call LilycoveCity_Harbor_EventScript_15998A
...
LilycoveCity_Harbor_EventScript_15998A:: @ 815998A
	loadptr 0, LilycoveCity_Harbor_Text_18B4B3
	callstd 4
	closebutton
...
LilycoveCity_Harbor_EventScript_1599E4:: @ 81599E4
	loadptr 0, LilycoveCity_Harbor_Text_18B45B
	callstd 4
	release
	end
...
LilycoveCity_Harbor_EventScript_1599EE:: @ 81599EE
	...
	checkflag 2131
	jumpif 0, LilycoveCity_Harbor_EventScript_1598BA
	loadptr 0, LilycoveCity_Harbor_Text_1C50F2
	callstd 4
	closebutton
	move LAST_TALKED, LilycoveCity_Harbor_Movement_1A0841
	waitmove 0
	...
	waitmove 0
	loadptr 0, LilycoveCity_Harbor_Text_1C5120
	callstd 4
	closebutton
...
LilycoveCity_Harbor_EventScript_159A8D:: @ 8159A8D
	...
	loadptr 0, LilycoveCity_Harbor_Text_18B504
	callstd 4
	release
	end

LilycoveCity_Harbor_EventScript_159AA2:: @ 8159AA2
	loadptr 0, LilycoveCity_Harbor_Text_18B58E
	callstd 4
	release
	end
