...
LilycoveCity_ContestLobby_EventScript_158898:: @ 8158898
	...
	waitmove 0
	loadptr 0, LilycoveCity_ContestLobby_Text_18890F
	callstd 4
	lockall
	fadescreen 1
	showcontestwinner 0
	lockall
	loadptr 0, LilycoveCity_ContestLobby_Text_1889FD
	callstd 5
	compare RESULT, 1
...
LilycoveCity_ContestLobby_EventScript_1588DE:: @ 81588DE
	loadptr 0, LilycoveCity_ContestLobby_Text_188AE8
	callstd 4
	closebutton
	special 135
	setvar 0x4099, 0
...
LilycoveCity_ContestLobby_EventScript_158918:: @ 8158918
	loadptr 0, LilycoveCity_ContestLobby_Text_188C41
	callstd 5
	compare RESULT, 1
	jumpeq LilycoveCity_ContestLobby_EventScript_1588DE
	loadptr 0, LilycoveCity_ContestLobby_Text_188CBD
	callstd 4
	closebutton
	move 4, LilycoveCity_ContestLobby_Movement_158A43
	waitmove 0
...
LilycoveCity_ContestLobby_EventScript_158948:: @ 8158948
	...
	waitmove 0
	loadptr 0, LilycoveCity_ContestLobby_Text_188BB5
	callstd 4
	fanfare 370
	loadptr 0, LilycoveCity_ContestLobby_Text_188C03
	callstd 4
	waitfanfare
	loadptr 0, LilycoveCity_ContestLobby_Text_188C19
	callstd 4
	loadptr 0, LilycoveCity_ContestLobby_Text_188C32
	callstd 4
	closebutton
	return
...
LilycoveCity_ContestLobby_EventScript_158BBA:: @ 8158BBA
	loadptr 0, LilycoveCity_ContestLobby_Text_1A63F4
	callstd 4
	releaseall
	end

LilycoveCity_ContestLobby_EventScript_158BC4:: @ 8158BC4
	loadptr 0, LilycoveCity_ContestLobby_Text_188521
	callstd 5
	compare RESULT, 0
...
LilycoveCity_ContestLobby_EventScript_158C42:: @ 8158C42
	loadptr 0, LilycoveCity_ContestLobby_Text_188703
	callstd 4
	setvar 0x8010, 0
	choosecontestpkmn
	compare 0x8004, 255
...
LilycoveCity_ContestLobby_EventScript_158D82:: @ 8158D82
	loadptr 0, LilycoveCity_ContestLobby_Text_188750
	callstd 4
...
LilycoveCity_ContestLobby_EventScript_158D90:: @ 8158D90
	special 31
	loadptr 0, LilycoveCity_ContestLobby_Text_18878D
	callstd 4
	closebutton
	releaseall
	clearflag 3
...
LilycoveCity_ContestLobby_EventScript_158DA1:: @ 8158DA1
	special 31
	loadptr 0, LilycoveCity_ContestLobby_Text_1887F4
	callstd 4
	closebutton
	releaseall
	clearflag 3
...
LilycoveCity_ContestLobby_EventScript_158DB2:: @ 8158DB2
	special 31
	loadptr 0, LilycoveCity_ContestLobby_Text_18881F
	callstd 4
	closebutton
	releaseall
	clearflag 3
...
LilycoveCity_ContestLobby_EventScript_158DC3:: @ 8158DC3
	loadptr 0, LilycoveCity_ContestLobby_Text_18873A
	callstd 4
	jump LilycoveCity_ContestLobby_EventScript_158CEA
	end
...
LilycoveCity_ContestLobby_EventScript_158F86:: @ 8158F86
	...
	waitmove 0
	loadptr 0, LilycoveCity_ContestLobby_Text_1A6832
	callstd 4
	closebutton
...
LilycoveCity_ContestLobby_EventScript_15901E:: @ 815901E
	loadptr 0, LilycoveCity_ContestLobby_Text_188D3C
	callstd 2
	end
...
LilycoveCity_ContestLobby_EventScript_159027:: @ 8159027
	...
	loadptr 0, LilycoveCity_ContestLobby_Text_188DDA
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_159039:: @ 8159039
	loadptr 0, LilycoveCity_ContestLobby_Text_188E47
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_159042:: @ 8159042
	loadptr 0, LilycoveCity_ContestLobby_Text_188F07
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_15904B:: @ 815904B
	loadptr 0, LilycoveCity_ContestLobby_Text_188F81
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_159054:: @ 8159054
	loadptr 0, LilycoveCity_ContestLobby_Text_188FE3
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_15905D:: @ 815905D
	loadptr 0, LilycoveCity_ContestLobby_Text_18904D
	callstd 2
	end
...
LilycoveCity_ContestLobby_EventScript_15907B:: @ 815907B
	loadptr 0, LilycoveCity_ContestLobby_Text_1B7225
	callstd 2
	end

LilycoveCity_ContestLobby_EventScript_159084:: @ 8159084
	loadptr 0, LilycoveCity_ContestLobby_Text_1B7241
	callstd 2
	end
