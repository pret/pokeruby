...
Route110_EventScript_14F946:: @ 814F946
	lock
	faceplayer
	loadptr 0, Route110_Text_16E6C0
	callstd 4
...
Route110_EventScript_14F95C:: @ 814F95C
	lock
	faceplayer
	loadptr 0, Route110_Text_16E6F2
	callstd 4
	move LAST_TALKED, Route110_Movement_1A083D
	waitmove 0
	release
...
Route110_EventScript_14F972:: @ 814F972
	lock
	faceplayer
	loadptr 0, Route110_Text_16E729
	callstd 4
	move LAST_TALKED, Route110_Movement_1A083D
	waitmove 0
	release
...
Route110_EventScript_14F988:: @ 814F988
	lock
	faceplayer
	loadptr 0, Route110_Text_16E76A
	callstd 4
	move LAST_TALKED, Route110_Movement_1A083D
	waitmove 0
	release
...
Route110_EventScript_14FA2E:: @ 814FA2E
	...
	loadptr 0, Route110_Text_16F53A
	callstd 4
	releaseall
	end

Route110_EventScript_14FA49:: @ 814FA49
	loadptr 0, Route110_Text_16F57C
	callstd 4
	releaseall
	end
...
Route110_EventScript_14FA53:: @ 814FA53
	...
	loadptr 0, Route110_Text_16F26A
	callstd 4
	release
	end

Route110_EventScript_14FA7A:: @ 814FA7A
	loadptr 0, Route110_Text_16F1D0
	callstd 4
	release
	end

Route110_EventScript_14FA84:: @ 814FA84
	loadptr 0, Route110_Text_16F2C4
	callstd 4
	release
	end
...
Route110_EventScript_14FC39:: @ 814FC39
	special 228
	loadptr 0, Route110_Text_16EF65
	callstd 4
	switch RESULT
...
Route110_EventScript_14FDB1:: @ 814FDB1
	loadptr 0, Route110_Text_16E7A1
	callstd 4
	switch 0x4023
...
Route110_EventScript_14FE8A:: @ 814FE8A
	loadptr 0, Route110_Text_16EA2A
	callstd 4
	call Route110_EventScript_14FEA5
	loadptr 0, Route110_Text_16EA7B
	callstd 4
	jump Route110_EventScript_14FEB2
	end
