...
OldaleTown_EventScript_14DDAA:: @ 814DDAA
	loadptr 0, OldaleTown_Text_16B20E
	callstd 3
	end

OldaleTown_EventScript_14DDB3:: @ 814DDB3
	loadptr 0, OldaleTown_Text_16AEC0
	callstd 2
	end
...
OldaleTown_EventScript_14DDBC:: @ 814DDBC
	...
	setflag 1
	playmusic 420, 0
	loadptr 0, OldaleTown_Text_16AEF2
	callstd 4
	closebutton
	switch FACING
...
OldaleTown_EventScript_14DE4C:: @ 814DE4C
	loadptr 0, OldaleTown_Text_16AF2F
	callstd 4
	...
	loadptr 0, OldaleTown_Text_16AFE1
	callstd 4
	setflag 132
	fadedefault
	release
...
OldaleTown_EventScript_14DE83:: @ 814DE83
	loadptr 0, OldaleTown_Text_1A0CC2
	callstd 4
	fadedefault
	release
	end
...
OldaleTown_EventScript_14DEDF:: @ 814DEDF
	...
	loadptr 0, OldaleTown_Text_16B0CC
	callstd 4
	closebutton
...
OldaleTown_EventScript_14DEFF:: @ 814DEFF
	...
	waitmove 0
	loadptr 0, OldaleTown_Text_16B045
	callstd 4
	closebutton
...
OldaleTown_EventScript_14DF26:: @ 814DF26
	loadptr 0, OldaleTown_Text_16B12A
	callstd 4
	release
	end
