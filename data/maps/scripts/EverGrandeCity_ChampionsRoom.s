...
EverGrandeCity_ChampionsRoom_EventScript_15B805:: @ 815B805
	playmusic 454, 0
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_190F9C
	callstd 4
...
EverGrandeCity_ChampionsRoom_EventScript_15B821:: @ 815B821
	...
	special 142
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_1910FE
	callstd 4
	closebutton
	playsfx 8
	checkgender
...
EverGrandeCity_ChampionsRoom_EventScript_15B886:: @ 815B886
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_191225
	callstd 4
	pause 40
	playsfx 21
...
EverGrandeCity_ChampionsRoom_EventScript_15B8BB:: @ 815B8BB
	...
	waitmove 0
	call EverGrandeCity_ChampionsRoom_EventScript_15B9D2
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_191305
	callstd 4
	jump EverGrandeCity_ChampionsRoom_EventScript_15B8F0
	end
...
EverGrandeCity_ChampionsRoom_EventScript_15B8F0:: @ 815B8F0
	...
	waitmove 0
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_19134D
	callstd 4
	call EverGrandeCity_ChampionsRoom_EventScript_1A03B0
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_1914C6
	callstd 4
	...
	waitmove 0
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_191512
	callstd 4
	closebutton
	pause 30
	...
	waitmove 0
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_191546
	callstd 4
	checkgender
	compare RESULT, 0
...
EverGrandeCity_ChampionsRoom_EventScript_15B9AB:: @ 815B9AB
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_1915D7
	callstd 4
	return

EverGrandeCity_ChampionsRoom_EventScript_15B9B4:: @ 815B9B4
	loadptr 0, EverGrandeCity_ChampionsRoom_Text_191675
	callstd 4
	return
