...
MtPyre_Summit_EventScript_15D4E1:: @ 815D4E1
	...
	loadptr 0, MtPyre_Summit_Text_1B5EEC
	callstd 4
	closebutton
	fadescreen 1
	disappear 2
	...
	loadptr 0, MtPyre_Summit_Text_1B5FE6
	callstd 4
	setorcopyvar 0x8000, 0x114
...
MtPyre_Summit_EventScript_15D5EF:: @ 815D5EF
	lock
	faceplayer
	loadptr 0, MtPyre_Summit_Text_1B64B3
	callstd 5
	compare RESULT, 1
...
MtPyre_Summit_EventScript_15D611:: @ 815D611
	loadptr 0, MtPyre_Summit_Text_1B65D6
	callstd 4
	return

MtPyre_Summit_EventScript_15D61A:: @ 815D61A
	loadptr 0, MtPyre_Summit_Text_1B6823
	callstd 4
	return
...
MtPyre_Summit_EventScript_15D623:: @ 815D623
	...
	loadptr 0, MtPyre_Summit_Text_1B60F9
	callstd 4
	release
	end

MtPyre_Summit_EventScript_15D64A:: @ 815D64A
	loadptr 0, MtPyre_Summit_Text_1B6283
	callstd 5
	compare RESULT, 1
...
MtPyre_Summit_EventScript_15D669:: @ 815D669
	...
	waitmove 0
	pause 10
	loadptr 0, MtPyre_Summit_Text_1B639C
	callstd 4
	setflag 259
	release
	end
...
MtPyre_Summit_EventScript_15D69B:: @ 815D69B
	loadptr 0, MtPyre_Summit_Text_1B62E7
	callstd 5
	compare RESULT, 1
	jumpeq MtPyre_Summit_EventScript_15D669
	compare RESULT, 0
...
MtPyre_Summit_EventScript_15D6BA:: @ 815D6BA
	loadptr 0, MtPyre_Summit_Text_1B617B
	callstd 4
	release
	end

MtPyre_Summit_EventScript_15D6C4:: @ 815D6C4
	loadptr 0, MtPyre_Summit_Text_1B63F8
	callstd 4
	release
	end
...
MtPyre_Summit_EventScript_15D6F2:: @ 815D6F2
	...
	loadptr 0, MtPyre_Summit_Text_1B6848
	callstd 4
	closebutton
	compare 0x8008, 0
