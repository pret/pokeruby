...
SeafloorCavern_Room9_EventScript_15DAFA:: @ 815DAFA
	...
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4850
	callstd 4
	closebutton
	reappear 0x8004
	...
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B486C
	callstd 4
	move 0x8004, SeafloorCavern_Room9_Movement_1A0841
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4897
	callstd 4
	move 0x8004, SeafloorCavern_Room9_Movement_1A0839
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B491F
	callstd 4
	trainerbattle 3, 601, 0, SeafloorCavern_Room9_Text_1B49AE
	loadptr 0, SeafloorCavern_Room9_Text_1B49C1
	callstd 4
	setweather 0
	doweather
	special 332
	waitstate
	loadptr 0, SeafloorCavern_Room9_Text_1B4A5A
	callstd 4
	special 284
	waitstate
	setvar RESULT, 0
	...
	setvar 0x8006, 4
	setvar 0x8007, 5
	loadptr 0, SeafloorCavern_Room9_Text_1B4A89
	callstd 4
	playsfx 2
	move 255, SeafloorCavern_Room9_Movement_1A083F
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4ADB
	callstd 4
	closebutton
	move 0x8004, SeafloorCavern_Room9_Movement_15DD41
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4B11
	callstd 4
	closebutton
	playsfx 3
	pause 20
	...
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4C79
	callstd 4
	closebutton
	reappear 0x8005
	reappear 0x8006
	...
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4D02
	callstd 4
	playsfx 21
	...
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4DD3
	callstd 4
	loadptr 0, SeafloorCavern_Room9_Text_1B4E37
	callstd 4
	closebutton
	move 0x8005, SeafloorCavern_Room9_Movement_15DD60
	move 0x8004, SeafloorCavern_Room9_Movement_15DD46
	waitmove 0
	loadptr 0, SeafloorCavern_Room9_Text_1B4ECA
	callstd 4
	setvar 0x407b, 1
	clearflag 855
	clearflag 856
