...
SootopolisCity_Gym_1F_EventScript_15AFFF:: @ 815AFFF
	...
	loadptr 0, SootopolisCity_Gym_1F_Text_18F4D7
	callstd 4
	release
	end
...
SootopolisCity_Gym_1F_EventScript_15B02D:: @ 815B02D
	...
	loadptr 0, SootopolisCity_Gym_1F_Text_18F36B
	callstd 4
	setflag 1236
	setflag 2062
	setvar 0x8008, 8
...
SootopolisCity_Gym_1F_EventScript_15B056:: @ 815B056
	...
	loadptr 0, SootopolisCity_Gym_1F_Text_18F466
	callstd 4
	setflag 172
	release
	end
...
SootopolisCity_Gym_1F_EventScript_15B07A:: @ 815B07A
	loadptr 0, SootopolisCity_Gym_1F_Text_18F5B4
	callstd 4
	release
	end
...
SootopolisCity_Gym_1F_EventScript_15B084:: @ 815B084
	...
	loadptr 0, SootopolisCity_Gym_1F_Text_18E8A5
	callstd 4
	release
	end

SootopolisCity_Gym_1F_EventScript_15B099:: @ 815B099
	loadptr 0, SootopolisCity_Gym_1F_Text_18E9C9
	callstd 4
	release
	end
...
SootopolisCity_Gym_1F_EventScript_15B0C3:: @ 815B0C3
	loadptr 0, SootopolisCity_Gym_1F_Text_18F665
	callstd 4
	releaseall
	end

SootopolisCity_Gym_1F_EventScript_15B0CD:: @ 815B0CD
	loadptr 0, SootopolisCity_Gym_1F_Text_18F649
	callstd 4
	releaseall
	end
