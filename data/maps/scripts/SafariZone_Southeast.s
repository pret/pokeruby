...
SafariZone_Southeast_EventScript_16008C:: @ 816008C
	loadptr 0, SafariZone_Southeast_Text_1C3B71
	callstd 2
	end

SafariZone_Southeast_EventScript_160095:: @ 8160095
	loadptr 0, SafariZone_Southeast_Text_1C3BBD
	callstd 2
	end

SafariZone_Southeast_EventScript_16009E:: @ 816009E
	loadptr 0, SafariZone_Southeast_Text_1C3DCE
	callstd 2
	end
...
SafariZone_Southeast_EventScript_1600A7:: @ 81600A7
	...
	loadptr 0, SafariZone_Southeast_Text_1C3A56
	callstd 5
	compare RESULT, 1
	jumpeq SafariZone_Southeast_EventScript_1600E0
	loadptr 0, SafariZone_Southeast_Text_1C3A9C
	callstd 4
	release
	end
...
SafariZone_Southeast_EventScript_1600D1:: @ 81600D1
	setvar 0x4001, 1
	loadptr 0, SafariZone_Southeast_Text_1C3B2D
	callstd 4
	release
	end

SafariZone_Southeast_EventScript_1600E0:: @ 81600E0
	loadptr 0, SafariZone_Southeast_Text_1C3ACA
	callstd 4
	closebutton
	switch FACING
