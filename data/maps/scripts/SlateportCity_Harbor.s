...
SlateportCity_Harbor_EventScript_155FD5:: @ 8155FD5
	...
	waitmove 0
	loadptr 0, SlateportCity_Harbor_Text_17FD7D
	callstd 4
	closebutton
	...
	compare 0x8008, 3
	callif 1, SlateportCity_Harbor_EventScript_156086
	loadptr 0, SlateportCity_Harbor_Text_17FE60
	callstd 4
	closebutton
	setflag 821
	setflag 822
...
SlateportCity_Harbor_EventScript_1560C4:: @ 81560C4
	...
	loadptr 0, SlateportCity_Harbor_Text_17FA0A
	callstd 4
	release
	end

SlateportCity_Harbor_EventScript_1560D9:: @ 81560D9
	loadptr 0, SlateportCity_Harbor_Text_17FA73
	callstd 4
...
SlateportCity_Harbor_EventScript_156135:: @ 8156135
	loadptr 0, SlateportCity_Harbor_Text_17FAAD
	callstd 4
	release
	end

SlateportCity_Harbor_EventScript_15613F:: @ 815613F
	loadptr 0, SlateportCity_Harbor_Text_17FB81
	callstd 5
	compare RESULT, 0
...
SlateportCity_Harbor_EventScript_156167:: @ 8156167
	loadptr 0, SlateportCity_Harbor_Text_17FB9C
	callstd 5
	compare RESULT, 0
	jumpeq SlateportCity_Harbor_EventScript_15618A
	call SlateportCity_Harbor_EventScript_156196
...
SlateportCity_Harbor_EventScript_156196:: @ 8156196
	loadptr 0, SlateportCity_Harbor_Text_17FBB6
	callstd 4
	closebutton
...
SlateportCity_Harbor_EventScript_1561DA:: @ 81561DA
	loadptr 0, SlateportCity_Harbor_Text_17FB5F
	callstd 4
	release
	end
...
SlateportCity_Harbor_EventScript_1561FF:: @ 81561FF
	loadptr 0, SlateportCity_Harbor_Text_17FC07
	callstd 2
	end

SlateportCity_Harbor_EventScript_156208:: @ 8156208
	loadptr 0, SlateportCity_Harbor_Text_17FC7C
	callstd 2
	end
...
SlateportCity_Harbor_EventScript_156211:: @ 8156211
	...
	loadptr 0, SlateportCity_Harbor_Text_17FD1C
	callstd 4
	closebutton
...
SlateportCity_Harbor_EventScript_156258:: @ 8156258
	setflag 271
	loadptr 0, SlateportCity_Harbor_Text_17FF35
	callstd 4
	release
	end

SlateportCity_Harbor_EventScript_156265:: @ 8156265
	loadptr 0, SlateportCity_Harbor_Text_1800A0
	callstd 4
	release
	end
...
SlateportCity_Harbor_EventScript_15626F:: @ 815626F
	...
	loadptr 0, SlateportCity_Harbor_Text_18017B
	callstd 4
	release
	end

SlateportCity_Harbor_EventScript_15629D:: @ 815629D
	loadptr 0, SlateportCity_Harbor_Text_1801EA
	callstd 4
	release
	end
...
SlateportCity_Harbor_EventScript_1562EA:: @ 81562EA
	loadptr 0, SlateportCity_Harbor_Text_1803DD
	callstd 5
	compare RESULT, 0
	...
	loadptr 0, SlateportCity_Harbor_Text_18046B
	callstd 4
	setflag 294
...
SlateportCity_Harbor_EventScript_15632A:: @ 815632A
	loadptr 0, SlateportCity_Harbor_Text_180412
	callstd 5
	compare RESULT, 0
	jumpeq SlateportCity_Harbor_EventScript_156374
...
SlateportCity_Harbor_EventScript_15636A:: @ 815636A
	loadptr 0, SlateportCity_Harbor_Text_180360
	callstd 4
	release
	end
...
SlateportCity_Harbor_EventScript_156380:: @ 8156380
	setvar 0x4001, 1
	loadptr 0, SlateportCity_Harbor_Text_180491
	callstd 4
	release
	end
