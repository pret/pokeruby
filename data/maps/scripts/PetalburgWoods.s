...
PetalburgWoods_EventScript_15CCA8:: @ 815CCA8
	...
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194D92
	callstd 4
	closebutton
	playmusic 441, 0
	move 3, PetalburgWoods_Movement_15CEC3
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194DED
	callstd 4
	closebutton
	...
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194E6B
	callstd 4
	closebutton
	move 4, PetalburgWoods_Movement_15CE9E
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194E9A
	callstd 4
	move 3, PetalburgWoods_Movement_15CEC8
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194EE8
	callstd 4
...
PetalburgWoods_EventScript_15CDE6:: @ 815CDE6
	...
	waitmove 0
	loadptr 0, PetalburgWoods_Text_194D71
	callstd 4
	closebutton
	return

PetalburgWoods_EventScript_15CDFA:: @ 815CDFA
	loadptr 0, PetalburgWoods_Text_194FA4
	callstd 4
	closebutton
	...
	waitmove 0
	loadptr 0, PetalburgWoods_Text_19507E
	callstd 4
...
PetalburgWoods_EventScript_15CE3F:: @ 815CE3F
	loadptr 0, PetalburgWoods_Text_195182
	callstd 4
	jump PetalburgWoods_EventScript_15CE4D
	end

PetalburgWoods_EventScript_15CE4D:: @ 815CE4D
	loadptr 0, PetalburgWoods_Text_19510A
	callstd 4
	move 4, PetalburgWoods_Movement_15CEA8
	waitmove 0
	loadptr 0, PetalburgWoods_Text_195153
	callstd 4
	closebutton
	return
...
PetalburgWoods_EventScript_15CECA:: @ 815CECA
	loadptr 0, PetalburgWoods_Text_1953AC
	callstd 2
	end

PetalburgWoods_EventScript_15CED3:: @ 815CED3
	loadptr 0, PetalburgWoods_Text_19542B
	callstd 2
	end
...
PetalburgWoods_EventScript_15CEDC:: @ 815CEDC
	...
	loadptr 0, PetalburgWoods_Text_19549E
	callstd 4
