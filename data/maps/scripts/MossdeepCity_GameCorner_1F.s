...
MossdeepCity_GameCorner_1F_EventScript_15AD22:: @ 815AD22
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E80E
	callstd 4
	return

MossdeepCity_GameCorner_1F_EventScript_15AD2B:: @ 815AD2B
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E859
	callstd 4
	return

MossdeepCity_GameCorner_1F_EventScript_15AD34:: @ 815AD34
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E7B1
	callstd 4
	return
...
MossdeepCity_GameCorner_1F_EventScript_15AD42:: @ 815AD42
	...
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E59A
	callstd 4
	release
	end
...
MossdeepCity_GameCorner_1F_EventScript_15AD59:: @ 815AD59
	special 39
	special 285
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E650
	callstd 5
	compare RESULT, 0
	...
	compare RESULT, 0
	jumpeq MossdeepCity_GameCorner_1F_EventScript_15ADE8
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E741
	callstd 5
	compare RESULT, 0
	...
	special 39
	special 248
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E777
	callstd 4
	closebutton
	compare FACING, 2
...
MossdeepCity_GameCorner_1F_EventScript_15ADE8:: @ 815ADE8
	special 40
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E698
	callstd 4
	release
	end

MossdeepCity_GameCorner_1F_EventScript_15ADF5:: @ 815ADF5
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E6DA
	callstd 4
	fadescreen 1
	special 41
	waitstate
...
MossdeepCity_GameCorner_1F_EventScript_15AE4C:: @ 815AE4C
	loadptr 0, MossdeepCity_GameCorner_1F_Text_18E631
	callstd 3
	end
