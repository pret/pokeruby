...
Route109_EventScript_14F548:: @ 814F548
	...
	loadptr 0, Route109_Text_16B4B5
	callstd 4
	closebutton
...
Route109_EventScript_14F691:: @ 814F691
	...
	loadptr 0, Route109_Text_16E0F9
	callstd 5
	compare RESULT, 0
...
Route109_EventScript_14F6E2:: @ 814F6E2
	loadptr 0, Route109_Text_16E159
	callstd 4
	closebutton
...
Route109_EventScript_14F6F1:: @ 814F6F1
	loadptr 0, Route109_Text_16E1B1
	callstd 4
	release
	end

Route109_EventScript_14F6FB:: @ 814F6FB
	loadptr 0, Route109_Text_16E2C5
	callstd 4
	release
	end

Route109_EventScript_14F705:: @ 814F705
	loadptr 0, Route109_Text_16E307
	callstd 2
	end
...
Route109_EventScript_14F70E:: @ 814F70E
	lock
	faceplayer
	loadptr 0, Route109_Text_16E405
	callstd 4
	closebutton
...
Route109_EventScript_14F725:: @ 814F725
	...
	loadptr 0, Route109_Text_16E433
	callstd 4
...
Route109_EventScript_14F762:: @ 814F762
	loadptr 0, Route109_Text_16E446
	callstd 4
	move LAST_TALKED, Route109_Movement_1A083D
	waitmove 0
	release
...
Route109_EventScript_14F776:: @ 814F776
	loadptr 0, Route109_Text_16E35B
	callstd 2
	end

Route109_EventScript_14F77F:: @ 814F77F
	loadptr 0, Route109_Text_16E4D5
	callstd 2
	end
...
Route109_EventScript_14F788:: @ 814F788
	...
	loadptr 0, Route109_Text_16E5CA
	callstd 4
	waitpokecry
	release
	end
