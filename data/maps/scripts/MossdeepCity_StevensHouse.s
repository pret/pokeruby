...
MossdeepCity_StevensHouse_EventScript_15AA0B:: @ 815AA0B
	...
	waitmove 0
	loadptr 0, MossdeepCity_StevensHouse_Text_18DA77
	callstd 4
	...
	setflag 123
	setflag 302
	loadptr 0, MossdeepCity_StevensHouse_Text_18DB22
	callstd 4
	closebutton
	pause 20
...
MossdeepCity_StevensHouse_EventScript_15AA7C:: @ 815AA7C
	lockall
	loadptr 0, MossdeepCity_StevensHouse_Text_18DD12
	callstd 5
	compare RESULT, 0
	...
	loadptr 0, MossdeepCity_StevensHouse_Text_1A1102
	callstd 5
	compare RESULT, 1
...
MossdeepCity_StevensHouse_EventScript_15AADC:: @ 815AADC
	loadptr 0, MossdeepCity_StevensHouse_Text_18DD77
	callstd 4
	releaseall
	end

MossdeepCity_StevensHouse_EventScript_15AAE6:: @ 815AAE6
	loadptr 0, MossdeepCity_StevensHouse_Text_18DD9E
	callstd 4
	releaseall
	end

MossdeepCity_StevensHouse_EventScript_15AAF0:: @ 815AAF0
	loadptr 0, MossdeepCity_StevensHouse_Text_18E0A3
	callstd 3
	end

MossdeepCity_StevensHouse_EventScript_15AAF9:: @ 815AAF9
	loadptr 0, MossdeepCity_StevensHouse_Text_18DC25
	callstd 2
	end
...
MossdeepCity_StevensHouse_EventScript_15AB02:: @ 815AB02
	...
	loadptr 0, MossdeepCity_StevensHouse_Text_18DF1A
	callstd 4
	releaseall
	end

MossdeepCity_StevensHouse_EventScript_15AB16:: @ 815AB16
	loadptr 0, MossdeepCity_StevensHouse_Text_18DDC2
	callstd 4
	releaseall
	end
