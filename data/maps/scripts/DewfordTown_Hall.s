...
DewfordTown_Hall_EventScript_153293:: @ 8153293
	...
	loadptr 0, DewfordTown_Hall_Text_1754C9
	callstd 4
	release
	end

DewfordTown_Hall_EventScript_1532B2:: @ 81532B2
	loadptr 0, DewfordTown_Hall_Text_175528
	callstd 4
	release
	end
...
DewfordTown_Hall_EventScript_1532BC:: @ 81532BC
	...
	faceplayer
	call DewfordTown_Hall_EventScript_1A0102
	loadptr 0, DewfordTown_Hall_Text_17559E
	callstd 4
	release
	end
...
DewfordTown_Hall_EventScript_1532CD:: @ 81532CD
	...
	call DewfordTown_Hall_EventScript_1A0102
	special 128
	loadptr 0, DewfordTown_Hall_Text_1755F9
	callstd 5
	compare RESULT, 1
...
DewfordTown_Hall_EventScript_1532F6:: @ 81532F6
	loadptr 0, DewfordTown_Hall_Text_175664
	callstd 4
	release
	end

DewfordTown_Hall_EventScript_153300:: @ 8153300
	loadptr 0, DewfordTown_Hall_Text_1756B7
	callstd 4
	release
	end
...
DewfordTown_Hall_EventScript_15330A:: @ 815330A
	...
	faceplayer
	call DewfordTown_Hall_EventScript_1A0102
	loadptr 0, DewfordTown_Hall_Text_17570D
	callstd 4
	closebutton
...
DewfordTown_Hall_EventScript_153326:: @ 8153326
	...
	faceplayer
	call DewfordTown_Hall_EventScript_1A0102
	loadptr 0, DewfordTown_Hall_Text_17574C
	callstd 4
	closebutton
...
DewfordTown_Hall_EventScript_153342:: @ 8153342
	...
	faceplayer
	call DewfordTown_Hall_EventScript_1A0102
	loadptr 0, DewfordTown_Hall_Text_175779
	callstd 4
	release
	end
...
DewfordTown_Hall_EventScript_153353:: @ 8153353
	lockall
	call DewfordTown_Hall_EventScript_1A0102
	loadptr 0, DewfordTown_Hall_Text_175842
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_1533CA:: @ 81533CA
	loadptr 0, DewfordTown_Hall_Text_1758C4
	callstd 4
	releaseall
	end

DewfordTown_Hall_EventScript_1533D4:: @ 81533D4
	loadptr 0, DewfordTown_Hall_Text_1758E0
	callstd 4
	releaseall
	end

DewfordTown_Hall_EventScript_1533DE:: @ 81533DE
	loadptr 0, DewfordTown_Hall_Text_1758FB
	callstd 4
	releaseall
	end

DewfordTown_Hall_EventScript_1533E8:: @ 81533E8
	loadptr 0, DewfordTown_Hall_Text_175916
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_153470:: @ 8153470
	...
	loadptr 0, DewfordTown_Hall_Text_175935
	callstd 4
	call DewfordTown_Hall_EventScript_153535
	loadptr 0, DewfordTown_Hall_Text_1759A1
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_15348C:: @ 815348C
	call DewfordTown_Hall_EventScript_1534FD
	loadptr 0, DewfordTown_Hall_Text_175A5C
	callstd 4
	call DewfordTown_Hall_EventScript_153535
	loadptr 0, DewfordTown_Hall_Text_175AD9
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_1534A8:: @ 81534A8
	call DewfordTown_Hall_EventScript_1534FD
	loadptr 0, DewfordTown_Hall_Text_175B46
	callstd 4
	call DewfordTown_Hall_EventScript_153535
	loadptr 0, DewfordTown_Hall_Text_175BA7
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_1534C4:: @ 81534C4
	call DewfordTown_Hall_EventScript_1534FD
	loadptr 0, DewfordTown_Hall_Text_175C41
	callstd 4
	call DewfordTown_Hall_EventScript_153535
	loadptr 0, DewfordTown_Hall_Text_175CC2
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_1534E0:: @ 81534E0
	call DewfordTown_Hall_EventScript_1534FD
	loadptr 0, DewfordTown_Hall_Text_175D6B
	callstd 4
	call DewfordTown_Hall_EventScript_153535
	loadptr 0, DewfordTown_Hall_Text_175DC3
	callstd 4
	releaseall
	end
...
DewfordTown_Hall_EventScript_15359D:: @ 815359D
	...
	loadptr 0, DewfordTown_Hall_Text_175E13
	callstd 4
...
DewfordTown_Hall_EventScript_1535D1:: @ 81535D1
	loadptr 0, DewfordTown_Hall_Text_175EBE
	callstd 4
	release
	end
