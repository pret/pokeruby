...
RusturfTunnel_EventScript_15C782:: @ 815C782
	lock
	faceplayer
	loadptr 0, RusturfTunnel_Text_194766
	callstd 4
	closebutton
...
RusturfTunnel_EventScript_15C799:: @ 815C799
	...
	setflag 1
	loadptr 0, RusturfTunnel_Text_1944C5
	callstd 4
	closebutton
	move LAST_TALKED, RusturfTunnel_Movement_1A083D
	waitmove 0
...
RusturfTunnel_EventScript_15C7BC:: @ 815C7BC
	loadptr 0, RusturfTunnel_Text_1945B2
	callstd 4
	closebutton
	move LAST_TALKED, RusturfTunnel_Movement_1A083D
	waitmove 0
...
RusturfTunnel_EventScript_15C7D1:: @ 815C7D1
	...
	loadptr 0, RusturfTunnel_Text_19461D
	callstd 4
	compare 0x4001, 2
	...
	callstd 0
	setflag 106
	loadptr 0, RusturfTunnel_Text_194693
	callstd 4
	closebutton
	compare 0x4001, 1
	...
	loadptr 0, RusturfTunnel_Text_194706
	callstd 4
	closebutton
	compare 0x4001, 1
...
RusturfTunnel_EventScript_15C9AB:: @ 815C9AB
	lockall
	loadptr 0, RusturfTunnel_Text_194159
	callstd 4
	closebutton
...
RusturfTunnel_EventScript_15C9D7:: @ 815C9D7
	...
	loadptr 0, RusturfTunnel_Text_194188
	callstd 4
	waitpokecry
	release
	end
...
RusturfTunnel_EventScript_15C9EA:: @ 815C9EA
	...
	faceplayer
	playmusic 441, 0
	loadptr 0, RusturfTunnel_Text_19419B
	callstd 4
	trainerbattle 3, 581, 0, RusturfTunnel_Text_194243
	loadptr 0, RusturfTunnel_Text_194274
	callstd 4
	...
	waitmove 0
	loadptr 0, RusturfTunnel_Text_19432A
	callstd 4
...
RusturfTunnel_EventScript_15CACD:: @ 815CACD
	...
	loadptr 0, RusturfTunnel_Text_1948C4
	callstd 6
	end
