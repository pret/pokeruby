...
LavaridgeTown_EventScript_14E5AB:: @ 814E5AB
	loadptr 0, LavaridgeTown_Text_16BDA4
	callstd 4
	setorcopyvar 0x8000, 0x117
	setorcopyvar 0x8001, 0x1
	callstd 0
	setflag 221
	loadptr 0, LavaridgeTown_Text_16BE7D
	callstd 4
	jump LavaridgeTown_EventScript_14E5F5
	end

LavaridgeTown_EventScript_14E5D0:: @ 814E5D0
	loadptr 0, LavaridgeTown_Text_16BF92
	callstd 4
	setorcopyvar 0x8000, 0x117
	setorcopyvar 0x8001, 0x1
	callstd 0
	setflag 221
	loadptr 0, LavaridgeTown_Text_16C020
	callstd 4
	jump LavaridgeTown_EventScript_14E5F5
	end
...
LavaridgeTown_EventScript_14E724:: @ 814E724
	loadptr 0, LavaridgeTown_Text_16C3FD
	callstd 2
	end

LavaridgeTown_EventScript_14E72D:: @ 814E72D
	loadptr 0, LavaridgeTown_Text_16C4DB
	callstd 3
	end

LavaridgeTown_EventScript_14E736:: @ 814E736
	loadptr 0, LavaridgeTown_Text_16C59B
	callstd 2
	end

LavaridgeTown_EventScript_14E73F:: @ 814E73F
	loadptr 0, LavaridgeTown_Text_16C603
	callstd 2
	end

LavaridgeTown_EventScript_14E748:: @ 814E748
	loadptr 0, LavaridgeTown_Text_16C694
	callstd 2
	end

LavaridgeTown_EventScript_14E751:: @ 814E751
	loadptr 0, LavaridgeTown_Text_16C54E
	callstd 2
	end
...
LavaridgeTown_EventScript_14E75A:: @ 814E75A
	...
	loadptr 0, LavaridgeTown_Text_16C174
	callstd 5
	compare RESULT, 0
	...
	loadptr 0, LavaridgeTown_Text_16C2B6
	callstd 4
	setflag 266
	fanfare 370
...
LavaridgeTown_EventScript_14E79E:: @ 814E79E
	loadptr 0, LavaridgeTown_Text_16C398
	callstd 4
	release
	end

LavaridgeTown_EventScript_14E7A8:: @ 814E7A8
	loadptr 0, LavaridgeTown_Text_16C2FF
	callstd 4
	release
	end

LavaridgeTown_EventScript_14E7B2:: @ 814E7B2
	loadptr 0, LavaridgeTown_Text_16C33C
	callstd 4
	release
	end

LavaridgeTown_EventScript_14E7BC:: @ 814E7BC
	loadptr 0, LavaridgeTown_Text_16C72F
	callstd 3
	end

LavaridgeTown_EventScript_14E7C5:: @ 814E7C5
	loadptr 0, LavaridgeTown_Text_16C77C
	callstd 3
	end
...
LavaridgeTown_EventScript_14E7D7:: @ 814E7D7
	loadptr 0, LavaridgeTown_Text_16C7CF
	callstd 3
	end
