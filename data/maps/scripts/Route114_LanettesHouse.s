...
Route114_LanettesHouse_EventScript_15C262:: @ 815C262
	...
	setflag 2123
	loadptr 0, Route114_LanettesHouse_Text_192A0D
	callstd 4
	setorcopyvar 0x8000, 0x64
	callstd 7
	compare RESULT, 0
...
Route114_LanettesHouse_EventScript_15C28F:: @ 815C28F
	loadptr 0, Route114_LanettesHouse_Text_192ACC
	callstd 4
	release
	end
...
Route114_LanettesHouse_EventScript_15C299:: @ 815C299
	lockall
	loadptr 0, Route114_LanettesHouse_Text_192B4A
	callstd 5
	compare RESULT, 1
	jumpeq Route114_LanettesHouse_EventScript_15C2B7
	loadptr 0, Route114_LanettesHouse_Text_192DA9
	callstd 4
	releaseall
	end

Route114_LanettesHouse_EventScript_15C2B7:: @ 815C2B7
	loadptr 0, Route114_LanettesHouse_Text_192C01
	callstd 5
	compare RESULT, 1
...
Route114_LanettesHouse_EventScript_15C2CC:: @ 815C2CC
	loadptr 0, Route114_LanettesHouse_Text_192CB4
	callstd 4
	return

Route114_LanettesHouse_EventScript_15C2D5:: @ 815C2D5
	loadptr 0, Route114_LanettesHouse_Text_192DC1
	callstd 3
	end
