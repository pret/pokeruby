...
Route124_DivingTreasureHuntersHouse_EventScript_163E04:: @ 8163E04
	...
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F416
	callstd 4
	setflag 217
...
Route124_DivingTreasureHuntersHouse_EventScript_163E20:: @ 8163E20
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F48F
	callstd 4
	jump Route124_DivingTreasureHuntersHouse_EventScript_163E2E
	end
...
Route124_DivingTreasureHuntersHouse_EventScript_163EA2:: @ 8163EA2
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F544
	callstd 4
...
Route124_DivingTreasureHuntersHouse_EventScript_164292:: @ 8164292
	bufferitem 0, 0x8008
	bufferitem 1, 0x8009
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F5E0
	callstd 5
	compare RESULT, 0
...
Route124_DivingTreasureHuntersHouse_EventScript_1642D3:: @ 81642D3
	...
	callstd 0
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F606
	callstd 4
	call Route124_DivingTreasureHuntersHouse_EventScript_163E44
	compare 0x4001, 0
	jumpeq Route124_DivingTreasureHuntersHouse_EventScript_164333
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F629
	callstd 5
	compare RESULT, 1
...
Route124_DivingTreasureHuntersHouse_EventScript_164315:: @ 8164315
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F64E
	callstd 4
	release
	end

Route124_DivingTreasureHuntersHouse_EventScript_16431F:: @ 816431F
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F686
	callstd 4
	release
	end

Route124_DivingTreasureHuntersHouse_EventScript_164329:: @ 8164329
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F4D1
	callstd 4
	release
	end
...
Route124_DivingTreasureHuntersHouse_EventScript_164335:: @ 8164335
	loadptr 0, Route124_DivingTreasureHuntersHouse_Text_19F6C5
	callstd 3
	end
