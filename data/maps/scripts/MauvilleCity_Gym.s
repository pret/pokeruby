...
MauvilleCity_Gym_EventScript_1565AB:: @ 81565AB
	...
	loadptr 0, MauvilleCity_Gym_Text_180EDB
	callstd 4
	release
	end
...
MauvilleCity_Gym_EventScript_1565DB:: @ 81565DB
	...
	loadptr 0, MauvilleCity_Gym_Text_180DDA
	callstd 4
	setflag 1208
	setflag 2057
	addvar 0x4085, 1
...
MauvilleCity_Gym_EventScript_15661D:: @ 815661D
	...
	loadptr 0, MauvilleCity_Gym_Text_180E76
	callstd 4
	setflag 167
	release
	end
...
MauvilleCity_Gym_EventScript_156641:: @ 8156641
	loadptr 0, MauvilleCity_Gym_Text_180F1D
	callstd 4
	release
	end
...
MauvilleCity_Gym_EventScript_1566E6:: @ 81566E6
	...
	loadptr 0, MauvilleCity_Gym_Text_1809D1
	callstd 6
	end
...
MauvilleCity_Gym_EventScript_1566FD:: @ 81566FD
	...
	loadptr 0, MauvilleCity_Gym_Text_180A5E
	callstd 6
	end
...
MauvilleCity_Gym_EventScript_156714:: @ 8156714
	...
	loadptr 0, MauvilleCity_Gym_Text_180B1D
	callstd 6
	end
...
MauvilleCity_Gym_EventScript_15672B:: @ 815672B
	...
	loadptr 0, MauvilleCity_Gym_Text_180BAE
	callstd 6
	end
...
MauvilleCity_Gym_EventScript_156742:: @ 8156742
	...
	loadptr 0, MauvilleCity_Gym_Text_180815
	callstd 4
	release
	end

MauvilleCity_Gym_EventScript_156757:: @ 8156757
	loadptr 0, MauvilleCity_Gym_Text_18091D
	callstd 4
	release
	end
...
MauvilleCity_Gym_EventScript_156781:: @ 8156781
	loadptr 0, MauvilleCity_Gym_Text_180F64
	callstd 4
	releaseall
	end

MauvilleCity_Gym_EventScript_15678B:: @ 815678B
	loadptr 0, MauvilleCity_Gym_Text_180F4A
	callstd 4
	releaseall
	end
