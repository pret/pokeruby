...
Route128_EventScript_15213F:: @ 815213F
	...
	waitmove 0
	loadptr 0, Route128_Text_171EE0
	callstd 4
	move 4, Route128_Movement_152279
	waitmove 0
	loadptr 0, Route128_Text_171F35
	callstd 4
	closebutton
	...
	waitmove 0
	loadptr 0, Route128_Text_171F4B
	callstd 4
	closebutton
	...
	waitmove 0
	loadptr 0, Route128_Text_172008
	callstd 4
	closebutton
	...
	waitmove 0
	loadptr 0, Route128_Text_17210B
	callstd 4
	closebutton
	pause 40
	...
	waitmove 0
	loadptr 0, Route128_Text_172181
	callstd 4
	closebutton
	move 3, Route128_Movement_15226D
	move 255, Route128_Movement_1A0841
	waitmove 0
	loadptr 0, Route128_Text_1722A1
	callstd 4
	move 3, Route128_Movement_1A0845
	waitmove 0
	loadptr 0, Route128_Text_1723BE
	callstd 4
	closebutton
	move 3, Route128_Movement_1A0845
	waitmove 0
