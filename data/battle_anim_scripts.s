...
Move_DOUBLE_EDGE: @ 81C817A
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 16, 16, 32767
	...
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_BANK_TARGET, 4, 0, 12, 1
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 16, 0, 32767
	waitforvisualfinish
...
Move_MEGA_PUNCH: @ 81C854D
	...
	monbg ANIM_BANK_TARGET
	delay 2
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 0, 16, 0
	setalpha 12, 8
...
Move_DETECT: @ 81C97D2
	loadspritegfx 10071
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 9, 0
	waitforvisualfinish
	...
	waitforvisualfinish
	delay 10
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 9, 0, 0
...
Move_MEAN_LOOK: @ 81CA31A
	...
	monbg ANIM_BANK_DEF_PARTNER
	playsewithpan SE_W060, 192
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 16, 0
	loopsewithpan SE_W109, 63, 15, 4
	waitplaysewithpan SE_W043, 63, 85
	createsprite gBattleAnimSpriteTemplate_8402264, 2
	delay 120
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 16, 0, 0
	delay 30
	clearmonbg ANIM_BANK_DEF_PARTNER
	waitforvisualfinish
	end
...
Move_CHARGE: @ 81CC1D0
	...
	monbg ANIM_BANK_ATTACKER
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 4, 0
	waitforvisualfinish
	...
	playsewithpan SE_W085B, 192
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 4, 4, 0, 0
	clearmonbg ANIM_BANK_ATTACKER
	blendoff
	end
...
_81CC4A7:
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 6, 0
	delay 37
	createsprite gBasicHitSplatSpriteTemplate, 3, 0, 0, 1, 1
	createsprite gFistFootSpriteTemplate, 2, 0, 0, 10, 1, 0
	playsewithpan SE_W233B, 63
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 6, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_TARGET
	end
_81CC576:
...
Move_ERUPTION: @ 81CC74F
	loadspritegfx 10201
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 31, 2, 0, 4, 31
	waitforvisualfinish
	...
	delay 80
	createsprite gSimplePaletteBlendSpriteTemplate, 40, 31, 4, 4, 0, 31
	end
...
Move_AROMATHERAPY: @ 81CCFAB
	...
	loadspritegfx 10203
	loadspritegfx 10049
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 1, 0, 0, 7, 13293
	delay 1
	monbg ANIM_BANK_ATTACKER
	delay 1
	...
	clearmonbg ANIM_BANK_ATTACKER
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 1, 0, 7, 0, 13293
	delay 1
	playsewithpan SE_W287, 192
	...
	waitforvisualfinish
	playsewithpan SE_REAPOKE, 192
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 43, 3, 10, 0, 13293
...
Move_GRASS_WHISTLE: @ 81CD249
	loadspritegfx 10072
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 4, 13298
	waitforvisualfinish
	createvisualtask sub_80CEA20, 2
	waitforvisualfinish
	...
	waitforvisualfinish
	createvisualtask sub_80CEAD8, 2
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 4, 4, 0, 13298
	waitforvisualfinish
	end

Move_TICKLE: @ 81CD33C
	loadspritegfx 10218
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 0, 0, 16, 0
	waitforvisualfinish
	createsprite gBattleAnimSpriteTemplate_83D7B94, 0, -16, -8
	createsprite gBattleAnimSpriteTemplate_83D7B94, 0, 16, -8
	playsewithpan SE_W197, 192
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 0, 16, 0, 0
	waitforvisualfinish
	delay 20
...
Move_ICE_PUNCH: @ 81CDB3E
	...
	loadspritegfx 10135
	loadspritegfx 10143
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 7, 0
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 7, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	end
...
Move_THUNDER: @ 81CDDCE
	...
	waitbgfadein
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 16, 0
	delay 16
	...
	createvisualtask sub_80E2324, 2, 257, 257, 257
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 130, 1, 2, 16, 0, 0
	waitforvisualfinish
	restorebg
	waitbgfadeout
	setarg 7, -1
...
Move_ICE_BEAM: @ 81CEB4D
	...
	call _81CEC4E
	call _81CEC4E
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 4, -31, 0, 7, 32384
	...
	delay 20
	call Unknown_81D5C36
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 4, 5, 7, 0, 32384
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 7, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_TARGET
...
Move_POWDER_SNOW: @ 81CF146
	loadspritegfx 10141
	monbg ANIM_BANK_DEF_PARTNER
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 31, 1, 0, 3, 0
	waitforvisualfinish
	panse_1B SE_W016, 192, 63, 2, 0
	call _81CF190
	call _81CF190
	...
	clearmonbg ANIM_BANK_DEF_PARTNER
	delay 20
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 31, 1, 3, 0, 0
	end
_81CF190:
...
Move_ABSORB: @ 81CF427
	...
	monbgprio_2A ANIM_BANK_TARGET
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 4, 13293
	waitforvisualfinish
	...
	call Unknown_81D5EF5
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 4, 0, 13293
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	end
...
Move_MEGA_DRAIN: @ 81CF53F
	...
	monbgprio_2A ANIM_BANK_TARGET
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 8, 13293
	waitforvisualfinish
	playsewithpan SE_W071, 63
	createsprite gBasicHitSplatSpriteTemplate, 2, 0, 0, 1, 1
	delay 2
	...
	call Unknown_81D5EF5
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 8, 0, 13293
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	end
...
Move_GIGA_DRAIN: @ 81CF6CF
	...
	monbgprio_2A ANIM_BANK_TARGET
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 12, 13293
	waitforvisualfinish
	playsewithpan SE_W071, 63
	createsprite gBasicHitSplatSpriteTemplate, 2, 0, 0, 1, 0
	delay 2
	...
	call Unknown_81D5EF5
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 12, 0, 13293
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	end
...
Move_LEECH_LIFE: @ 81CF8D7
	...
	call Unknown_81D5EF5
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 7, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	end
...
Move_WHIRLPOOL: @ 81D038C
	...
	setalpha 12, 8
	delay 0
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 4, 2, 0, 7, 23968
...
Move_STRING_SHOT: @ 81D1C98
	...
	monbg ANIM_BANK_DEF_PARTNER
	delay 0
	createsprite gSimplePaletteBlendSpriteTemplate, 5, 1, 2, 0, 9, 0
	waitforvisualfinish
	...
	delay 1
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 5, 1, 2, 9, 0, 0
	end
_81D1D56:
...
_81D2084:
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 16, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	end
_81D20EB:
...
Move_SOFT_BOILED: @ 81D213B
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 31, 3, 10, 0, 31500
...
Move_FAKE_OUT: @ 81D23A8
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 16, 0, 32767
	end

Move_SCARY_FACE: @ 81D23E3
	loadspritegfx 10218
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 27, 3, 0, 16, 0
	playsewithpan SE_W060, 192
	waitforvisualfinish
	delay 10
	playsewithpan SE_W043, 192
	...
	createvisualtask sub_80D60B4, 3, 20, 1, 0
	playsewithpan SE_W081B, 63
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 27, 3, 16, 0, 0
	waitforvisualfinish
	end
...
Move_PERISH_SONG: @ 81D2784
	...
	delay 80
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 0, 16, 0
	...
	delay 100
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 16, 0, 0
...
Move_WISH: @ 81D2D66
	loadspritegfx 10233
	loadspritegfx 10049
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 0, 10, 0
	waitforvisualfinish
	...
	call Unknown_81D5ECA
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 10, 0, 0
	waitforvisualfinish
	end
...
Move_STOCKPILE: @ 81D2DAE
	...
	call _81D2DEC
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 0, 12, 0, 32767
	end
_81D2DEC:
...
Move_HYPER_BEAM: @ 81D31EA
	loadspritegfx 10147
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 4, 0, 16, 0
	waitforvisualfinish
	delay 10
	playsewithpan SE_W063, 192
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 4, 16, 0, 0
	end
_81D331B:
...
Move_ROLE_PLAY: @ 81D3428
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 0, 10, 0
	waitforvisualfinish
	playsewithpan SE_W161, 192
	...
	createvisualtask sub_80E2A38, 10, 4, 2, 16, 0, 32767
	delay 8
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 2, 10, 0, 0
	end
...
_81D3562:
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 31, 3, 8, 0, 1023
...
Move_SAND_TOMB: @ 81D35D2
	loadspritegfx 10074
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 4, 2, 0, 7, 563
	...
	call _81D361F
	delay 22
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 4, 2, 7, 0, 563
	waitforvisualfinish
	end
_81D361F:
...
Move_FRENZY_PLANT: @ 81D3C7B
	...
	monbgprio_28 1
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 1, 2, 0, 5, 0
	waitforvisualfinish
	...
	playsewithpan SE_W003, 63
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 1, 2, 5, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_TARGET
	blendoff
	end
...
_81D401E:
	...
	goto _81D3F67
_81D4139:
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 0, 6, 0
	waitforvisualfinish
	createsprite gVerticalDipSpriteTemplate, 2, 16, 1, ANIM_BANK_ATTACKER
	createvisualtask sub_812B340, 5, 167, -64
	delay 8
	...
	createvisualtask sub_812B30C, 5, 141, 63
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 6, 0, 0
	goto _81D3F67
_81D4371:
...
Move_OVERHEAT: @ 81D4AFC
	...
	monbg ANIM_BANK_DEF_PARTNER
	setalpha 12, 18
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 5, 28
	waitforvisualfinish
	...
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 1, 0, 13, 28
	createvisualtask AnimTask_ShakeMon, 5, 0, 2, 0, 15, 1
	waitforvisualfinish
	playsewithpan SE_W172B, 192
	...
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, -1, 0, 13, 19026
	createvisualtask AnimTask_ShakeMon, 5, 0, 3, 0, 15, 1
	waitforvisualfinish
	createvisualtask sub_80E40D0, 5, 0, 1
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 5, 0, 28
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	blendoff
	waitforvisualfinish
	...
	delay 1
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 0, 13, 0, 19026
	waitforvisualfinish
	end
...
Move_WATER_PULSE: @ 81D50D2
	...
	monbgprio_28 1
	playsewithpan SE_W145C, 192
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 0, 0, 7, 29472
	delay 10
	...
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 7, 0, 29472
	waitforvisualfinish
	clearmonbg ANIM_BANK_DEF_PARTNER
	end
...
Move_DOOM_DESIRE: @ 81D52CB
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 0, 4, 0
	waitforvisualfinish
	setalpha 8, 8
	playsewithpan SE_W060, 192
	createvisualtask AnimTask_ScaleMonAndRestore, 5, -4, -4, 15, ANIM_BANK_ATTACKER, 1
	...
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 1, 4, 0, 0
	waitforvisualfinish
	clearmonbg ANIM_BANK_ATK_PARTNER
	blendoff
	end
...
Unknown_81D532F: @ 81D532F
	loadspritegfx 10198
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 1, 3, 0, 16, 32767
	waitforvisualfinish
	delay 10
...
General_ItemEffect: @ 81D661C
	...
	waitforvisualfinish
	playsewithpan SE_REAPOKE, 192
	createsprite gSimplePaletteBlendSpriteTemplate, 2, 2, 3, 7, 0, 26609
	createsprite gBattleAnimSpriteTemplate_83D7928, 3, 0, 0, 0, 0
	waitforvisualfinish
	end
...
General_HangedOn: @ 81D676E
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 2, 7, 0, 9, 31
	playsewithpan SE_W082, 192
	createvisualtask sub_812FC68, 5, 30, 128, 0, 1, 2, 0, 1
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, 0, 2, 4, 9, 0, 31
	waitforvisualfinish
	delay 6
