MauvilleCity_PokemonCenter_1F_EventScript_1B0816:: @ 81B0816
	...
	compare RESULT, 0
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B0914
	specialval RESULT, 107
	compare RESULT, 0
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B08D3
...
MauvilleCity_PokemonCenter_1F_EventScript_1B084F:: @ 81B084F
	...
	waitstate
	compare RESULT, 0
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B0883
	setvar 0x8008, 1
	special 108
	waittext
	waitbutton
	...
	compare RESULT, 0
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B0893
...
MauvilleCity_PokemonCenter_1F_EventScript_1B0893:: @ 81B0893
	...
	compare RESULT, 1
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B084F

MauvilleCity_PokemonCenter_1F_EventScript_1B08AE:: @ 81B08AE
	specialval RESULT, 112
	compare RESULT, 1
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B091F
	specialval RESULT, 107
	compare RESULT, 4
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B091F
...
MauvilleCity_PokemonCenter_1F_EventScript_1B08DB:: @ 81B08DB
	...
	compare RESULT, 1
	jumpif EQUAL, MauvilleCity_PokemonCenter_1F_EventScript_1B0909
