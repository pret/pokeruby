...
MauvilleCity_Gym_MapScript1_156456:: @ 8156456
	checkflag 1208
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_1565A7
	switch 0x4093
...
MauvilleCity_Gym_EventScript_156491:: @ 8156491
	checkflag 99
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_15649B
	end
...
MauvilleCity_Gym_EventScript_1565AB:: @ 81565AB
	...
	checkflag 167
	jumpif FLAG_NOT_SET, MauvilleCity_Gym_EventScript_15661D
	compare 0x40ba, 2
...
MauvilleCity_Gym_EventScript_15664B:: @ 815664B
	lockall
	checkflag 1208
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_1566DA
	compare 0x4093, 1
...
MauvilleCity_Gym_EventScript_1566BA:: @ 81566BA
	...
	playsfx 44
	checkflag 99
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_1566E1
	checkflag 99
	jumpif FLAG_NOT_SET, MauvilleCity_Gym_EventScript_1566DC
	releaseall
	end
...
MauvilleCity_Gym_EventScript_156742:: @ 8156742
	...
	faceplayer
	checkflag 1208
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_156757
...
MauvilleCity_Gym_EventScript_156761:: @ 8156761
	lockall
	checkflag 2057
	jumpif FLAG_IS_SET, MauvilleCity_Gym_EventScript_156781
