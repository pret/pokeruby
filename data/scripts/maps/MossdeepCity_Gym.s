...
MossdeepCity_Gym_EventScript_15A5EA:: @ 815A5EA
	lockall
	checkflag 100
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A621
	setflag 100
...
MossdeepCity_Gym_EventScript_15A646:: @ 815A646
	lockall
	checkflag 101
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A675
	setflag 101
	move 255, MossdeepCity_Gym_Movement_15A7F7
	waitmove 0
	setmaptile 8, 14, 516, 0
...
MossdeepCity_Gym_EventScript_15A69A:: @ 815A69A
	lockall
	checkflag 102
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A6C9
	setflag 102
	move 255, MossdeepCity_Gym_Movement_15A7F7
	waitmove 0
	setmaptile 15, 17, 524, 0
...
MossdeepCity_Gym_EventScript_15A6EE:: @ 815A6EE
	lockall
	checkflag 103
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A71D
	setflag 103
	move 255, MossdeepCity_Gym_Movement_15A7F7
	waitmove 0
	setmaptile 1, 23, 525, 0
...
MossdeepCity_Gym_EventScript_15A7D8:: @ 815A7D8
	...
	faceplayer
	checkflag 1229
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A7ED
...
MossdeepCity_Gym_EventScript_15A7FA:: @ 815A7FA
	lockall
	checkflag 2061
	jumpif EQUAL, MossdeepCity_Gym_EventScript_15A81A
