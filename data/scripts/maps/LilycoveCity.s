...
LilycoveCity_MapScript1_14CA20:: @ 814CA20
	...
	setflag 802
	checkflag 2090
	callif FLAG_IS_SET, LilycoveCity_EventScript_1A02C1
...
LilycoveCity_MapScript1_14CA3F:: @ 814CA3F
	...
	.endif
	checkflag 112
	callif FLAG_NOT_SET, LilycoveCity_EventScript_14CABE
	checkflag 2061
	callif FLAG_IS_SET, LilycoveCity_EventScript_14CB2B
	end
...
LilycoveCity_EventScript_14CB74:: @ 814CB74
	...
	checkdailyflags
	checkflag 2255
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CBB4
...
LilycoveCity_EventScript_14CBC7:: @ 814CBC7
	...
	faceplayer
	checkflag 2061
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CBDC
...
LilycoveCity_EventScript_14CBEF:: @ 814CBEF
	...
	faceplayer
	checkflag 112
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CC04
...
LilycoveCity_EventScript_14CC0E:: @ 814CC0E
	...
	faceplayer
	checkflag 112
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CC23
...
LilycoveCity_EventScript_14CC48:: @ 814CC48
	...
	faceplayer
	checkflag 2061
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CC5D
...
LilycoveCity_EventScript_14CCAC:: @ 814CCAC
	lockall
	checkflag 2052
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CCC0
...
LilycoveCity_EventScript_14CCE5:: @ 814CCE5
	lockall
	checkflag 218
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CD18
...
LilycoveCity_EventScript_14CD60:: @ 814CD60
	playmusic 415, 1
	checkflag 286
	callif FLAG_IS_SET, LilycoveCity_EventScript_14CDB0
	checkflag 286
	callif FLAG_NOT_SET, LilycoveCity_EventScript_14CDB9
	compare RESULT, 0
...
LilycoveCity_EventScript_14CDD3:: @ 814CDD3
	playmusic 421, 1
	checkflag 286
	callif FLAG_IS_SET, LilycoveCity_EventScript_14CE23
	checkflag 286
	callif FLAG_NOT_SET, LilycoveCity_EventScript_14CE2C
	compare RESULT, 0
...
LilycoveCity_EventScript_14CEDE:: @ 814CEDE
	checkflag 2062
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CEE8
	return
...
LilycoveCity_EventScript_14CEF7:: @ 814CEF7
	checkflag 2052
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CF09
...
LilycoveCity_EventScript_14CF50:: @ 814CF50
	checkflag 2052
	jumpif FLAG_IS_SET, LilycoveCity_EventScript_14CF62
