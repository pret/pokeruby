...
VerdanturfTown_WandasHouse_EventScript_153F5B:: @ 8153F5B
	...
	faceplayer
	checkflag 193
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_153F73
...
VerdanturfTown_WandasHouse_EventScript_153F7D:: @ 8153F7D
	...
	faceplayer
	checkflag 126
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_153FA5
	checkflag 1213
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_153F9B
...
VerdanturfTown_WandasHouse_EventScript_153FB8:: @ 8153FB8
	...
	faceplayer
	checkflag 1213
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_153FE0
	checkflag 190
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_153FD6
...
VerdanturfTown_WandasHouse_EventScript_153FEA:: @ 8153FEA
	...
	faceplayer
	checkflag 126
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_154025
	checkflag 1213
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_15401B
	checkflag 199
	jumpif FLAG_IS_SET, VerdanturfTown_WandasHouse_EventScript_154011
