...
Route123_BerryMastersHouse_EventScript_1639E9:: @ 81639E9
	...
	giveitem RESULT
	compare RESULT, 0
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_1A029B
	setflag 2253
...
Route123_BerryMastersHouse_EventScript_163A64:: @ 8163A64
	...
	faceplayer
	compare RESULT, 1
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163AAD
	compare RESULT, 0
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163A9B
	end
...
Route123_BerryMastersHouse_EventScript_163AAD:: @ 8163AAD
	...
	compare 0x8004, 1
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163B1E
	compare 0x8004, 2
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163B4F
	compare 0x8004, 3
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163B80
	compare 0x8004, 4
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163BB1
	compare 0x8004, 5
	jumpif EQUAL, Route123_BerryMastersHouse_EventScript_163BE2
	end
