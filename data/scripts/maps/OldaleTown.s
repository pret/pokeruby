...
OldaleTown_MapScript1_14DD68:: @ 814DD68
	...
	setflag 2064
	checkflag 116
	callif FLAG_NOT_SET, OldaleTown_EventScript_14DD92
	checkflag 132
	callif FLAG_NOT_SET, OldaleTown_EventScript_14DD9E
	checkflag 116
	callif FLAG_IS_SET, OldaleTown_EventScript_14DD8C
	end
...
OldaleTown_EventScript_14DDBC:: @ 814DDBC
	...
	faceplayer
	checkflag 132
	jumpif FLAG_IS_SET, OldaleTown_EventScript_14DE79
	checkflag 1
	jumpif FLAG_IS_SET, OldaleTown_EventScript_14DE79
	setflag 1
	playmusic 420, 0
...
OldaleTown_EventScript_14DEDF:: @ 814DEDF
	...
	faceplayer
	checkflag 116
	jumpif FLAG_IS_SET, OldaleTown_EventScript_14DF26
