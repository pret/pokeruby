...
Route104_Prototype_EventScript_160C4B:: @ 8160C4B
	...
	jumpif FLAG_NOT_SET, Route104_Prototype_EventScript_160C99
	...
	checkflag 216
	jumpif FLAG_IS_SET, Route104_Prototype_EventScript_160CFB
	release
	end
...
Route104_Prototype_EventScript_160CA3:: @ 8160CA3
	...
	faceplayer
	checktrainerflag OPPONENT_BRIANNA_1
	jumpif FLAG_NOT_SET, Route104_Prototype_EventScript_160CF1
	checktrainerflag OPPONENT_CINDY_2
	jumpif FLAG_NOT_SET, Route104_Prototype_EventScript_160CF1
	checktrainerflag OPPONENT_AMY_AND_LIV_3
	jumpif FLAG_NOT_SET, Route104_Prototype_EventScript_160CF1
