...
MoveEffect_Absorb: @ 81D6FFB
	...
	setbyte gUnknown_02024D1F+4, 0
	jump BattleScript_1D703F

BattleScript_1D7037: @ 81D7037
	manipulatedamage 0
	setbyte gUnknown_02024D1F+4, 1
...
MoveEffect_BurnHit: @ 81D7069
	setbyte gUnknown_02024D1F+2, 3
	jump BattleScript_1D6F14

MoveEffect_FreezeHit: @ 81D7074
	setbyte gUnknown_02024D1F+2, 4
	jump BattleScript_1D6F14

MoveEffect_ParalyzeHit: @ 81D707F
	setbyte gUnknown_02024D1F+2, 5
	jump BattleScript_1D6F14
...
BattleScript_1D71B3: @ 81D71B3
	...
	jumpifbyte 1, gUnknown_02024D1F+4, 2, BattleScript_1D71CE
	pause 32
...
BattleScript_1D7227: @ 81D7227
	...
	jumpifbyte 3, gUnknown_02024D1F+4, 2, BattleScript_1D725F
	jumpifbyte 0, gUnknown_02024D1F+4, 3, BattleScript_1D7271
	pause 32
...
BattleScript_1D7322: @ 81D7322
	atk25
	copyarray gUnknown_02024D1F+2, 0x2016112, 1
	critcalc
	atk5
	atk6
...
MoveEffect_PayDay: @ 81D747D
	setbyte gUnknown_02024D1F+2, 11
	jump BattleScript_1D6F14
...
BattleScript_1D753D: @ 81D753D
	attackcanceler
	setbyte gUnknown_02024D1F+2, 12
	setbyte 0x2016002, 1
	clearstatus USER
...
BattleScript_1D756C: @ 81D756C
	...
	waitanimation
	orword gHitMarker, 0x8000000
	setbyte gUnknown_02024D1F+2, 76
	seteffecttarget
	copyarray gUnknown_02024D1F+4, 0x2016055, 1
...
BattleScript_1D7602: @ 81D7602
	setbyte gUnknown_02024D1F+2, 13
	jump BattleScript_1D6F14
...
MoveEffect_Recoil: @ 81D76A6
	setbyte gUnknown_02024D1F+2, 206
...
MoveEffect_Paralyze: @ 81D77F6
	...
	jumpifsecondarytstatus TARGET, S_SUBSTITUTE, BattleScript_1D83D6
	atk6
	jumpifbyte 4, gBattleMoveFlags, 41, BattleScript_1D83D6
...
MoveEffect_AttackDownHit: @ 81D7873
	setbyte gUnknown_02024D1F+2, 22
	jump BattleScript_1D6F14

MoveEffect_DefenseDownHit: @ 81D787E
	setbyte gUnknown_02024D1F+2, 23
	jump BattleScript_1D6F14

MoveEffect_SpeedDownHit: @ 81D7889
	setbyte gUnknown_02024D1F+2, 24
	jump BattleScript_1D6F14

MoveEffect_SpecialAttackDownHit: @ 81D7894
	setbyte gUnknown_02024D1F+2, 25
	jump BattleScript_1D6F14

MoveEffect_SpecialDefenseDownHit: @ 81D789F
	setbyte gUnknown_02024D1F+2, 26
	jump BattleScript_1D6F14

MoveEffect_AccuracyDownHit: @ 81D78AA
	setbyte gUnknown_02024D1F+2, 27
	jump BattleScript_1D6F14
...
MoveEffect_Substitute: @ 81D7900
	...
	setsubstituteeffect
	jumpifbyte 1, gUnknown_02024D1F+4, 1, BattleScript_1D7922
	pause 32
...
MoveEffect_Recharge: @ 81D7943
	attackcanceler
	accuracycheck BattleScript_1D6F72, 0
	setbyte gUnknown_02024D1F+2, 221
	jump BattleScript_1D6F42
...
MoveEffect_Rage: @ 81D7961
	...
	setbyte gUnknown_02024D1F+2, 30
	seteffecttarget
	setbyte gUnknown_02024D1F+2, 0
	jump BattleScript_1D6F42
...
MoveEffect_PainSplit: @ 81D7A79
	...
	graphicalhpupdate USER
	datahpupdate USER
	copyarray gBattleMoveDamage, 0x2016014, 4
	graphicalhpupdate TARGET
	datahpupdate TARGET
...
MoveEffect_HealBell: @ 81D7BB5
	...
	jumpifbyte 5, gUnknown_02024D1F+4, 1, BattleScript_1D7BE1
	printstring BATTLE_TEXT_BlocksOther
	waitmessage 64

BattleScript_1D7BE1: @ 81D7BE1
	jumpifbyte 5, gUnknown_02024D1F+4, 2, BattleScript_1D7BF2
...
BattleScript_1D7C2E: @ 81D7C2E
	...
	addbyte 0x20160e4, 1
	copyarray gDynamicBasePower, 0x20160de, 2
	critcalc
	atk5
	atk6
	atk7
...
MoveEffect_Thief: @ 81D7CC1
	setbyte gUnknown_02024D1F+2, 31
	jump BattleScript_1D6F14
...
MoveEffect_MeanLook: @ 81D7CCC
	...
	attackanimation
	waitanimation
	setbyte gUnknown_02024D1F+2, 32
	seteffecttarget
...
BattleScript_1D7D1A: @ 81D7D1A
	attackanimation
	waitanimation
	setbyte gUnknown_02024D1F+2, 33
	seteffecttarget
...
BattleScript_1D7E5A: @ 81D7E5A
	addbyte 0x2016003, 1
	jumpifarraynotequal 0x2016003, gNoOfAllBanks, 1, BattleScript_1D7E53
	jump BattleScript_EndTurn
...
MoveEffect_Swagger: @ 81D7EA2
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D7EE5
	atk47
	playanimation TARGET, 1, 0x20160a4
	printfromtable BattleTextList_401570
	waitmessage 64
...
MoveEffect_RapidSpin: @ 81D7FA9
	setbyte gUnknown_02024D1F+2, 163
	jump BattleScript_1D6F14
...
MoveEffect_DefenseUpHit: @ 81D8017
	setbyte gUnknown_02024D1F+2, 80
	jump BattleScript_1D6F14

MoveEffect_AttackUpHit: @ 81D8022
	setbyte gUnknown_02024D1F+2, 79
	jump BattleScript_1D6F14

MoveEffect_AllStatsUpHit: @ 81D802D
	setbyte gUnknown_02024D1F+2, 98
	jump BattleScript_1D6F14
...
MoveEffect_SkullBash: @ 81D8085
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D80CF
	atk47
	playanimation USER, 1, 0x20160a4
	printfromtable BattleTextList_401570
	waitmessage 64
...
MoveEffect_Teleport: @ 81D8233
	...
	attackstring
	ppreduce
	jumpifhalfword 4, gBattleTypeFlags, 8, BattleScript_1D83D6
	atk76 USER, 2
	jumpifbyte 0, gBattleCommunication, 1, BattleScript_1D83D6
	jumpifbyte 0, gBattleCommunication, 2, BattleScript_1D8839
	attackanimation
	waitanimation
	printstring BATTLE_TEXT_FledBattle
	waitmessage 64
	setbyte gUnknown_02024D1F+7, 5
	jump BattleScript_EndTurn
...
MoveEffect_DefenseCurl: @ 81D8370
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D71D8
	attackanimation
	waitanimation
...
MoveEffect_FakeOut: @ 81D83C3
	...
	setbyte gUnknown_02024D1F+2, 136
	jump BattleScript_1D6F14
...
MoveEffect_Uproar: @ 81D83FA
	attackcanceler
	accuracycheck BattleScript_1D6F72, 0
	setbyte gUnknown_02024D1F+2, 74
	attackstring
...
MoveEffect_SpitUp: @ 81D842D
	attackcanceler
	jumpifbyte 0, gUnknown_02024D1F+5, 1, BattleScript_1D845C
	attackstring
	ppreduce
	accuracycheck BattleScript_1D6F72, 0
...
MoveEffect_Flatter: @ 81D84B1
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D84F4
	atk47
	playanimation TARGET, 1, 0x20160a4
	printfromtable BattleTextList_401570
	waitmessage 64
...
MoveEffect_Memento: @ 81D8583
	attackcanceler
	jumpifbyte 0, gUnknown_02024D1F+5, 1, BattleScript_1D860A
	attackstring
	ppreduce
	...
	jumpifbyte 2, gUnknown_02024D1F+4, 1, BattleScript_1D85D0
	printfromtable BattleTextList_40157C
	waitmessage 64
...
BattleScript_1D85D0: @ 81D85D0
	...
	jumpifbyte 2, gUnknown_02024D1F+4, 1, BattleScript_1D85F3
	printfromtable BattleTextList_40157C
	waitmessage 64
...
MoveEffect_Smellingsalt: @ 81D8652
	...
	setbyte gUnknown_02024D1F+2, 164
...
MoveEffect_Superpower: @ 81D8762
	setbyte gUnknown_02024D1F+2, 229
	jump BattleScript_1D6F14
...
MoveEffect_KnockOff: @ 81D8847
	setbyte gUnknown_02024D1F+2, 54
	jump BattleScript_1D6F14
...
MoveEffect_DoubleEdge: @ 81D891E
	setbyte gUnknown_02024D1F+2, 230
	jump BattleScript_1D6F14
...
MoveEffect_Overheat: @ 81D89FF
	setbyte gUnknown_02024D1F+2, 251
	jump BattleScript_1D6F14
...
BattleScript_1D8A1F: @ 81D8A1F
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8A55
	printfromtable BattleTextList_40157C
	waitmessage 64
...
BattleScript_1D8A55: @ 81D8A55
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8A78
	printfromtable BattleTextList_40157C
	waitmessage 64
...
BattleScript_1D8AA6: @ 81D8AA6
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8AD1
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8AD1: @ 81D8AD1
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8AF0
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8B18: @ 81D8B18
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8B43
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8B43: @ 81D8B43
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8B62
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8B7C: @ 81D8B7C
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8BA7
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8BA7: @ 81D8BA7
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8BC6
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8BF4: @ 81D8BF4
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8C1F
	printfromtable BattleTextList_401570
	waitmessage 64
...
BattleScript_1D8C1F: @ 81D8C1F
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8C3E
	printfromtable BattleTextList_401570
	waitmessage 64
...
gUnknown_081D8C7B:: @ 81D8C7B
	...
	jumpifbyte 1, gUnknown_02024D1F+7, 0, BattleScript_1D8D86
...
gUnknown_081D8F62:: @ 81D8F62
	...
	waitmessage 64
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D8F7C
...
BattleScript_1D8FD6: @ 81D8FD6
	jumpifbyte 1, gUnknown_02024D1F+7, 0, BattleScript_1D8FF5
...
gUnknown_081D904B:: @ 81D904B
	...
	manipulatedamage 0
	setbyte gUnknown_02024D1F+4, 3
	jump BattleScript_1D9083

BattleScript_1D907D: @ 81D907D
	setbyte gUnknown_02024D1F+4, 4
...
gUnknown_081D90B2:: @ 81D90B2
	...
	atk6
	bicbyte gBattleMoveFlags, 6
	copyarray gBattleMoveDamage, 0x2016090, 4
	atk69
	setbyte 0x2016002, 1
	attackanimation
	waitanimation
...
gUnknown_081D92D7:: @ 81D92D7
	...
	waitmessage 64
	jumpifbyte 1, gUnknown_02024D1F+4, 0, BattleScript_1D92F4
...
BattleScript_1D92FB: @ 81D92FB
	atk8
	jumpifbyte 1, gUnknown_02024D1F+4, 0, BattleScript_1D9313
...
gUnknown_081D93FA:: @ 81D93FA
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D9427
	printfromtable BattleTextList_40157C
	waitmessage 64
...
BattleScript_1D9427: @ 81D9427
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D944A
	printfromtable BattleTextList_40157C
	waitmessage 64
...
gUnknown_081D94B0:: @ 81D94B0
	...
	jumpifbyte 0, gUnknown_02024D1F+4, 2, BattleScript_1D94D9
	printfromtable BattleTextList_40157C
	waitmessage 64
...
gUnknown_081D9595:: @ 81D9595
	...
	waitmessage 64
	atk65 1, 0x7
	jumpifbyte 0, gUnknown_02024D1F+4, 0, BattleScript_1D95D3
...
BattleScript_1D9767: @ 81D9767
	castformswitch
	addbyte 0x2016003, 1
	jumpifarraynotequal 0x2016003, gNoOfAllBanks, 1, BattleScript_1D9767
	return
...
BattleScript_1D97A1: @ 81D97A1
	...
	jumpifbyte 2, gUnknown_02024D1F+4, 1, BattleScript_1D97E4
	atk47
	playanimation TARGET, 1, 0x20160a4
...
gUnknown_081D9989:: @ 81D9989
	...
	waitmessage 64
	setbyte gUnknown_02024D1F+2, 65
	seteffecttarget
	setbyte 0x201600c, 0
	atk49 2, 16
	end
...
gUnknown_081D9AD4:: @ 81D9AD4
	...
	waitmessage 64
	setbyte gUnknown_02024D1F+2, 71
	seteffecttarget
	removeitem USER
	end2
